  ...
  <section>
    ...
    <article>
      <div class="example-wrapper">
        ...
        <pre><code
        class="language-html"
        >&lt;wt-notification&gt;lorem ipsum&lt;/wt-notification&gt;</code></pre>
      </div>
      <div class="example-wrapper">
    ...
    <article>
      ...
      <pre><code
        class="language-html"
>&lt;wt-notification&gt;Hello there!&lt;/wt-notification&gt;</code>
...
<script>
  ...
  export default {
    name: 'WtNotificationDocs',
    data: () => ({
      properties: [
        {
          value: 'type',
          code: '<wt-notification type="error"></wt-notification>',
          type: 'String',
          options: ['"info"', '"error"'],
          default: 'info',
        },
