...
1. В Admin/Permissions/Objects –> RbAC - додаємо ролі, які мають право на всі Записи.


2. В карточці конкретного запису (Permissions tab) – додаємо ролі, які мають право на цей конкретний Запис.

>[!IMPORTANT]
>Детальніше про ObAC vs RbAC можна прочитати у окремому питанні з [faq](../faq/Readme.md#чим-відрізняються-obac-і-rbac)
