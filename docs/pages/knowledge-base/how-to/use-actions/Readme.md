...
Action виконує наступні дії:
1. створює release-гілку від `main`
2. bumps версію в `main` на наступну
3. створює тег GitHub Release
4. створює changelog
...
Якщо змінились спільні файли запускаються тести для всіх пакетів.
...
Логіка запуску аналогічна до тестів — лінтер запускається тільки для пакетів де були зміни
