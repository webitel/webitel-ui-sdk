...
**Важливо: Перевірте, що в таску прикріплено посилання на доку та макет, а також посилання на свагєр,
...
Переводимо задачу в статус "Investigation".
Також можна створити на себе ж таску в джирі з назвою "Естімейт задачі (назва задачі)" і в неї трекати час, витрачений на естімейт.
...
Тобто буквально прописати для себе кроки реалізації: які компоненти треба змінити, а які дописати, чи потрібно дописувати апішки/стор, 
чи необхідний десь рефакторинг і так далі.
...
>Підзадачі мають бути такими, як ми їх виконуємо, а не такими, як були поділені юзер-сторі в доці до таски.
