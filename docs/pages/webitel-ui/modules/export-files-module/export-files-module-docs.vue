<template>
  <section class="modules">
    ...
    <article class="module">
      <p>
        Includes <b>FilesExport class</b> and <b>exportFilesMixin</b> in <b>/mixins</b> folder to
      ...
      <p>
        In computed, mixin has <b>filesDownloadProgress</b> and <b>filesZippingProgress</b> for files fetch
        and archive generation. <b>isFilesLoading</b> computed boolean indicator tracks loading progress
        like <code class="language-javascript">filesDownloadProgress || filesZippingProgress</code>
      </p>
      <p>
        <code class="language-javascript">this.FilesExport</code> has progress tracking properties:
