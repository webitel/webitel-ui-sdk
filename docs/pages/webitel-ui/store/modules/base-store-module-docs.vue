  ...
  <section class="store-modules">
    ...
    <section>
      ...
      <article>
        ...
        <p>
          Accepts <code>APIModule</code> object as param. Always used for next method: generateAPIActions.
          Default APIModule should have the following interface:
        </p>
      ...
      <article>
        ...
        <p>
          Returns store module itself, built from class state. If some props are passed, they are not deeply merged with
          class properties in created module. created module <code>"namespaced" = true</code> by default.
        </p>
      </article>
    </section>
  </section>
