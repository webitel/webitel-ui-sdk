...
import { castUiSectionToWtObject, getWtAppByUiSection, makeAppVisibilityMap, makeGlobalAccessMap, makeScopeAccessMap, makeSectionVisibilityMap, } from '../scripts/utils';
export const createUserAccessStore = ({ namespace = 'userinfo', useManualRouteGuards = false, } = {}) => {
    return defineStore(`${namespace}/access`, () => {
        ...
        const initialize = ({ permissions: rawGlobalAccess, scope: rawScopeAccess, access: rawVisibilityAccess, }) => {
