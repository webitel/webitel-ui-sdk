import {
  ...
  ScopeAccessMap, VisibilityAccess, UiSection, WtObject, WtApplication,
...
export const makeGlobalAccessMap = (rawGlobalAccess: GlobalAccessApiResponseItem[]): GlobalActionAccessMap => {
