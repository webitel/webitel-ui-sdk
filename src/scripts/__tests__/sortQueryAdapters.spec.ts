...
test('getNextSortOrder', () => {
	expect(sortQueryAdapters.getNextSortOrder('asc')).toBe('desc');
	expect(sortQueryAdapters.getNextSortOrder('desc')).toBe(null);
	expect(sortQueryAdapters.getNextSortOrder(null)).toBe('asc');
});
