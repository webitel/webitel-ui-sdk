...
export const AdminSections = {
  Agents: `${WtApplication.Admin}/agents`,
  ...
  ChatGateways: `${WtApplication.Admin}/chat-gateways`,
  Chatplan: `${WtApplication.Admin}/chatplan`,
  CognitiveProfiles: `${WtApplication.Admin}/cognitive-profiles`,
  ...
  EmailProfiles: `${WtApplication.Admin}/email-profiles`,
  Flow: `${WtApplication.Admin}/flow`,
  Gateways: `${WtApplication.Admin}/gateways`,
  GlobalVariables: `${WtApplication.Admin}/global-variables`,
  ImportCsv: `${WtApplication.Admin}/import-csv`,
  ...
  PauseCause: `${WtApplication.Admin}/pause-cause`,
  PauseTemplates: `${WtApplication.Admin}/pause-templates`,
  Queues: `${WtApplication.Admin}/queues`,
  Regions: `${WtApplication.Admin}/regions`,
  ResourceGroups: `${WtApplication.Admin}/resource-groups`,
  Resources: `${WtApplication.Admin}/resources`,
  Roles: `${WtApplication.Admin}/roles`,
  ShiftTemplates: `${WtApplication.Admin}/shift-templates`,
  SingleSignOn: `${WtApplication.Admin}/single-sign-on`,
  Skills: `${WtApplication.Admin}/skills`,
  Storage: `${WtApplication.Admin}/storage`,
  StoragePolicies: `${WtApplication.Admin}/storage-policies`,
  Teams: `${WtApplication.Admin}/teams`,
  Triggers: `${WtApplication.Admin}/triggers`,
  Users: `${WtApplication.Admin}/users`,
  WorkingConditions: `${WtApplication.Admin}/working-conditions`,
} as const;
