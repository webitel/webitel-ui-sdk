...
export const SearchTypeExtensionsQueryParams = zod.object({
	...
	sort: zod
		.array(
			zod
				.string()
				.regex(searchTypeExtensionsQuerySortItemRegExp)
				.default(searchTypeExtensionsQuerySortItemDefault),
		)
		.optional()
		.describe(
	...
	fields: zod
		.array(zod.string().default(searchTypeExtensionsQueryFieldsItemDefault))
		.optional()
		.describe(
