...
export const CatalogGetCustomersQueryParams = zod.object({
	page: zod.int().optional().describe('Page number to return. **default**: 1.'),
	size: zod.int().optional().describe('Page records limit. **default**: 16.'),
		...
		.array(
			zod
				.object({
					...
					closed_cause: zod.string().optional(),
					context: zod
							...
							zod
								.object({
									...
									invite: zod
										...
										.optional()
										.describe('OPTIONAL. Invite[d] BY member info.'),
									join: zod
										.string()
										.optional()
										.describe(
									...
									via: zod
										...
										.optional()
										.describe('[FROM] VIA text gateway profile.'),
								})
								.describe(
					...
					message: zod
						.object({
							chat: zod
								...
								.optional()
								.describe('Conversation the message belongs to ..'),
							context: zod
								.record(zod.string(), zod.string())
								.optional()
								.describe('Context. Variables. Environment.'),
							...
							keyboard: zod
													...
													.array(
														zod.object({
															...
															share: zod
																...
																.describe('Request to share contact info.'),
															text: zod
																.string()
																.optional()
								...
								.optional()
								.describe('Keyboard. Buttons. Quick Replies.'),
					...
					via: zod
						...
						.optional()
						.describe('[VIA] Text gateway [FROM] originated thru ...'),
				})
...
export const CatalogGetHistoryQueryParams = zod.object({
	...
	limit: zod.int().optional().describe('Number of messages to return.'),
...
export const CatalogGetHistoryResponse = zod.object({
	...
	next: zod.boolean().optional(),
	page: zod.int().optional().describe('Dataset page number.'),
	peers: zod
		.array(
			zod
				.object({
