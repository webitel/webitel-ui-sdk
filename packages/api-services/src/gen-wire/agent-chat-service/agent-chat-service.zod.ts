...
export const AgentChatServiceGetAgentChatsQueryParams = zod.object({
	size: zod.int().optional().describe('default'),
	page: zod.int().optional(),
	q: zod.string().optional(),
	fields: zod.array(zod.string()).optional(),
	sort: zod.string().optional(),
	only_closed: zod.boolean().optional().describe('filter'),
	only_unprocessed: zod.boolean().optional(),
});
	...
	items: zod
		.array(
			zod.object({
				...
				unprocessed_close: zod.boolean().optional(),
			}),
		)
		.optional(),
...
export const AgentChatServiceGetAgentChatsCounterQueryParams = zod.object({
	only_closed: zod.boolean().optional(),
	only_unprocessed: zod.boolean().optional(),
});
...
export const AgentChatServiceMarkChatProcessedResponse = zod.looseObject({});
