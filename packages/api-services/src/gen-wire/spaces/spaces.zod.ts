			...
			.array(
				zod
					.object({
						...
						reranker_model_id: zod
							.string()
							.optional()
							.describe('Reranker model id (type=reranker).'),
						target_embedding_model_id: zod
							.string()
							.optional()
							.describe(
...
export const CreateSpaceBody = zod
	.object({
		...
		reranker_model_id: zod.string().optional().describe('Reranker model id.'),
		team_ids: zod
			.array(zod.string())
			.optional()
			.describe(
