	...
	getDevices =
		...
		(axiosInstance: AxiosInstance = axios) => {
			...
			const updateDevice2 = (
				...
				return axiosInstance.patch(`/devices/${deviceId}`, updateDevice2Body, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const updateDevice = (
				...
				return axiosInstance.put(`/devices/${deviceId}`, updateDeviceBody, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const listRegistrations = (
				...
				return axiosInstance.get(`/devices/${deviceId}/registered`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const searchDeviceAudit = (
				...
				return axiosInstance.get(`/devices/${deviceId}/users/audit`, {
					...options,
					params: {
						...params,
						...options?.params,
