...
export const CreateSLAConditionBody = zod.object({
	...
	priorities: zod
		...
		.optional(),
	reaction_time: zod.string().optional(),
	resolution_time: zod.string().optional(),
});
...
export const ListSLAConditionsQueryParams = zod.object({
	...
	sla_condition_id: zod
		.string()
		.optional()
		.describe('Filter by SLACondition Id.'),
	priority_id: zod.string().optional().describe('filter by priority id'),
});
