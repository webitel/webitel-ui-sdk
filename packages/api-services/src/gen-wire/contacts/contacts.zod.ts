			...
			.array(
				zod
					.object({
						...
						external_user: zod.string().optional(),
						gateway_id: zod
							.string()
							.optional()
		...
		labels: zod
			.object({
				data: zod
					...
					.describe('Label(s) dataset page.'),
				next: zod.boolean().optional(),
				page: zod.int().optional().describe('Page number of partial result.'),
			})
			.optional()
			.describe("The Contact's associated tag(s)."),
		managers: zod
					...
					.array(
						zod.object({
							...
							codeblock: zod
								...
								.optional(),
							italic: zod.looseObject({}).optional(),
							length: zod.int().optional().describe('Length text runes count.'),
							link: zod
								.object({
									url: zod.string().optional(),
								})
								.optional(),
							monospace: zod.looseObject({}).optional(),
							offset: zod.int().optional().describe('Offset text runes count.'),
							strikethrough: zod.looseObject({}).optional(),
							underline: zod.looseObject({}).optional(),
						}),
					)
