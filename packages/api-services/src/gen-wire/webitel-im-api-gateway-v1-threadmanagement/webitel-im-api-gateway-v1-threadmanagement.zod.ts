					...
					.object({
						...
						settings: zod
							.object({
								...
								domain_id: zod.int().optional().describe('Domain identifier.'),
 ...
 */
export const ThreadManagementSearchLeftQueryParams = zod.object({
	fields: zod
		.array(zod.string())
		.optional()
		.describe(
	...
	.object({
		...
		last_msg: zod
			.object({
						...
						zod
							.object({
								...
								url: zod
									...
									.optional()
									.describe('Public signed URL for accessing the image.'),
								width: zod.int().optional().describe('Image width in pixels.'),
							})
							.describe(
								'Image represents an image attachment\nassociated with a message.',
							),
				...
				reacted_metadata: zod
					.object({
						button_code: zod.string().optional().describe('Button identifier.'),
						callback_data: zod
							.string()
							.optional()
							.describe('Optional callback payload.'),
...
export const ThreadManagementSearchVariablesQueryParams = zod.object({
	size: zod.int().optional().describe('Number of results to return per page.'),
	page: zod.int().optional().describe('Page number (1-based).'),
	fields: zod
		.array(zod.string())
		.optional()
