 ...
 */
export const AccountLogoutResponse = zod.looseObject({});

/**
 * @summary Inspect current Authorization credentials
 */
export const AccountInspectResponse = zod.object({
 ...
 */
export const AccountTokenBody = zod.object({
	client_id: zod
		.string()
		.optional()
		.describe(
...
export const AccountTokenResponse = zod.object({
	app_id: zod.string().optional(),
	contact: zod
		.object({
			birthdate: zod
