...
export const DeleteLDAPCatalog2Body = zod.object({
	...
	related_objects: zod.boolean().optional(),
});

export const DeleteLDAPCatalog2Response = zod.object({
	base_dn: zod.string().optional(),
	bind: zod
		.string()
		.optional()
		.describe('authorization method e.g.: SIMPLE, SAML, NTLM, etc.'),
	created_at: zod.string().optional().describe('unix'),
	created_by: zod
		.object({
			id: zod.string().optional(),
	...
	entry_modify: zod.string().optional(),
	entry_uuid: zod
		.string()
		.optional()
	...
	process: zod
		.object({
			...
			execute_at: zod.string().optional(),
			execute_by: zod
				.object({
					id: zod.string().optional(),
					name: zod.string().optional(),
			...
			options: zod
				.object({
					link_existing_objects: zod.boolean().optional(),
					reassign_device_users: zod.boolean().optional(),
	...
	templates: zod
		.array(
			zod.object({
				agent: zod.looseObject({}).optional(),
				base_dn: zod.string().optional(),
				catalog: zod
					.object({
						id: zod.string().optional(),
				...
				created_by: zod
					...
					.optional()
					.describe('UserId lookup value.'),
				device: zod.looseObject({}).optional(),
				enabled: zod.boolean().optional(),
				id: zod.string().optional(),
				name: zod.string().optional(),
				role: zod.looseObject({}).optional(),
...
export const LDAPSearch4Response = zod.object({
	...
	entries: zod.array(zod.looseObject({})).optional(),
	matchedDN: zod.string().optional(),
	referral: zod.array(zod.string()).optional(),
	resultCode: zod.int().optional(),
});
...
export const LDAPSearch3Body = zod.object({
	...
	controls: zod
		...
		.optional(),
	derefAliases: zod.int().optional(),
	filter: zod.string().optional(),
	password: zod.string().optional(),
	scope: zod.int().optional(),
...
export const DeleteLDAPCatalogQueryParams = zod.object({
	related_objects: zod.boolean().optional().describe('WITH objects bound to ?'),
});
