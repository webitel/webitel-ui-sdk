...
export const searchTypesQuerySortItemRegExp = /^[+|-|!]?\w+$/;
...
export const SearchTypesQueryParams = zod.object({
	...
	sort: zod
		.array(
			zod
				.string()
				.regex(searchTypesQuerySortItemRegExp)
				.default(searchTypesQuerySortItemDefault),
		)
		.optional()
		.describe(
	...
	fields: zod
		.array(zod.string().default(searchTypesQueryFieldsItemDefault))
		.optional()
		.describe(
...
export const SearchTypesResponse = zod
	.object({
		data: zod
			.array(
				zod
								...
								zod
									.object({
										...
										kind: zod
											...
											.default(searchTypesResponseDataItemFieldsItemKindDefault)
