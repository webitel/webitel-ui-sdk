...
export const DeleteConditionResponse = zod.object({
	...
	created_by: zod
		...
		.optional()
		.describe('The user who created this condition.'),
	expression: zod
		.string()
		.optional()
...
export const UpdateCondition2Body = zod
	.object({
		...
		position: zod
			.object({
				cond_down: zod.string().optional(),
				cond_up: zod.string().optional(),
			})
			.optional()
			.describe('The position of the condition in the group.'),
	})
