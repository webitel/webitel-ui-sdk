...
export const CreateArticleArticlesBody = zod
	.object({
		...
		parent_article: zod.string().optional().describe('The parent article ID.'),
		pinned: zod
			.boolean()
			.optional()
		...
		.array(
			zod.object({
				...
				parent_article: zod
					...
					.optional()
					.describe('The parent article ID.'),
				space_id: zod.string().optional().describe('Space ID associated with.'),
				text: zod
					.string()
					.optional()
					.describe('The text content of the article.'),
...
export const ListArticlesQueryParams = zod.object({
	...
	space_id: zod.string().optional().describe('Space to list within.'),
...
export const CreateArticleBody = zod
	.object({
		...
		parent_id: zod
			...
			.optional()
			.describe('Parent article id; 0 for a top-level article.'),
		space_id: zod.string().optional().describe('Target space.'),
		state: zod
			.enum([
				'ARTICLE_STATE_UNSPECIFIED',
				'DRAFT',
