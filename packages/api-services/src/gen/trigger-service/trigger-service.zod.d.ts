 ...
 */
export declare const SearchTriggerQueryParams: any;
...
export declare const SearchTriggerResponse: any;
/**
...
export declare const CreateTriggerBody: any;
...
export declare const CreateTriggerResponse: any;
/**
 * @summary Remove Trigger
 */
export declare const DeleteTriggerParams: any;
...
export declare const DeleteTriggerResponse: any;
/**
 * @summary Trigger item
 */
export declare const ReadTriggerParams: any;
...
export declare const ReadTriggerResponse: any;
export declare const PatchTriggerParams: any;
...
export declare const PatchTriggerBody: any;
...
export declare const PatchTriggerResponse: any;
/**
 * @summary Update Trigger
 */
export declare const UpdateTriggerParams: any;
...
export declare const UpdateTriggerBody: any;
...
export declare const UpdateTriggerResponse: any;
export declare const SearchTriggerJobParams: any;
export declare const SearchTriggerJobQueryParams: any;
export declare const searchTriggerJobResponseItemsItemStateDefault = "idle";
export declare const SearchTriggerJobResponse: any;
export declare const CreateTriggerJobParams: any;
export declare const CreateTriggerJobBody: any;
export declare const createTriggerJobResponseStateDefault = "idle";
export declare const CreateTriggerJobResponse: any;
