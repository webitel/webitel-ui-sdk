...
export const getListStatusConditionsResponseMock = (
	overrideResponse: Partial<CasesStatusConditionList> = {},
): CasesStatusConditionList => ({
...
export const getCreateStatusConditionResponseMock = (
	overrideResponse: Partial<CasesStatusCondition> = {},
): CasesStatusCondition => ({
	createdAt: faker.helpers.arrayElement([
		faker.number.int({ min: undefined, max: undefined }),
		undefined,
...
export const getLocateStatusConditionResponseMock = (
	overrideResponse: Partial<CasesLocateStatusConditionResponse> = {},
): CasesLocateStatusConditionResponse => ({
...
export const getListStatusConditionsMockHandler = (
	overrideResponse?:
		...
		| ((
		  ...
		  ) => Promise<CasesStatusConditionList> | CasesStatusConditionList),
) => {
...
export const getCreateStatusConditionMockHandler = (
	overrideResponse?:
		...
		| ((
		  ...
		  ) => Promise<CasesStatusCondition> | CasesStatusCondition),
) => {
...
export const getLocateStatusConditionMockHandler = (
	overrideResponse?:
		...
		| ((
				...
				| Promise<CasesLocateStatusConditionResponse>
				| CasesLocateStatusConditionResponse),
) => {
