...
getAgentWorkingConditionsService: (axiosInstance?: AxiosInstance) => {
    agentWorkingConditionsServiceReadAgentWorkingConditions: (agentId: string, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmReadAgentWorkingConditionsResponse>>;
    agentWorkingConditionsServiceUpdateAgentWorkingConditions: (agentId: string, agentWorkingConditionsServiceUpdateAgentWorkingConditionsBody: AgentWorkingConditionsServiceUpdateAgentWorkingConditionsBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmUpdateAgentWorkingConditionsResponse>>;
};
