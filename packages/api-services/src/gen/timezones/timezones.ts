...
export const // --- title start
	getTimezones =
		...
		(axiosInstance: AxiosInstance = axios) => {
			 ...
			 */
			const deleteTimezones = (
				contactId: string,
				params: DeleteTimezonesParams,
				options?: AxiosRequestConfig,
			): Promise<AxiosResponse<ContactsTimezoneList>> => {
				return axiosInstance.delete(`/contacts/${contactId}/timezones`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const listTimezones = (
				...
				return axiosInstance.get(`/contacts/${contactId}/timezones`, {
					...options,
					params: {
						...params,
						...options?.params,
			 ...
			 */
			const locateTimezone = (
				contactId: string,
				etag: string,
				params?: LocateTimezoneParams,
				options?: AxiosRequestConfig,
			): Promise<AxiosResponse<ContactsTimezone>> => {
				return axiosInstance.get(`/contacts/${contactId}/timezones/${etag}`, {
					...options,
					params: {
						...params,
						...options?.params,
