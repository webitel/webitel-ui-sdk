...
const deleteTimezones = <TData = AxiosResponse<ContactsTimezoneList>>(
    contactId: string,
    params: DeleteTimezonesParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.delete(
...
const listTimezones = <TData = AxiosResponse<ContactsTimezoneList>>(
    contactId: string,
    params?: ListTimezonesParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
      `/contacts/${contactId}/timezones`,{
    ...options,
...
const mergeTimezones = <TData = AxiosResponse<ContactsTimezoneList>>(
    ...
    params?: MergeTimezonesParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/contacts/${contactId}/timezones`,
      contactsInputTimezone,{
...
const resetTimezones = <TData = AxiosResponse<ContactsTimezoneList>>(
    contactId: string,
    contactsInputTimezone: ContactsInputTimezone[],
    params?: ResetTimezonesParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.put(
      `/contacts/${contactId}/timezones`,
      contactsInputTimezone,{
...
const deleteTimezone = <TData = AxiosResponse<ContactsTimezone>>(
    contactId: string,
    etag: string,
    params?: DeleteTimezoneParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.delete(
...
const locateTimezone = <TData = AxiosResponse<ContactsTimezone>>(
    contactId: string,
    etag: string,
    params?: LocateTimezoneParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
      `/contacts/${contactId}/timezones/${etag}`,{
    ...options,
...
const updateTimezone2 = <TData = AxiosResponse<ContactsTimezoneList>>(
    ...
    params?: UpdateTimezone2Params, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.patch(
      `/contacts/${contactId}/timezones/${etag}`,
      updateTimezone2Body,{
...
const updateTimezone = <TData = AxiosResponse<ContactsTimezoneList>>(
    ...
    params?: UpdateTimezoneParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.put(
      `/contacts/${contactId}/timezones/${etag}`,
      updateTimezoneBody,{
    ...options,
        params: {...params, ...options?.params},}
            ...
            // --- footer start
            return {deleteTimezones,listTimezones,mergeTimezones,resetTimezones,deleteTimezone,locateTimezone,updateTimezone2,updateTimezone}};
