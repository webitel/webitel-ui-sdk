...
export const getDeleteResponseMock = (overrideResponse: Partial< DataDataset > = {}): DataDataset => ({data: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({})), undefined]), next: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]), page: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), type: faker.helpers.arrayElement([{about: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), administered: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]), createdAt: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), createdBy: faker.helpers.arrayElement([{id: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), name: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), type: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined])}, undefined]), display: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), extendable: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]), fields: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({always: faker.helpers.arrayElement([{}, undefined]), binary: faker.helpers.arrayElement([{maxBytes: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), violation: faker.helpers.arrayElement([{
      ...
      }, undefined]), name: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), objclass: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), path: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), primary: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), readonly: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]), repo: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), updatedAt: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), updatedBy: faker.helpers.arrayElement([{id: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), name: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), type: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined])}, undefined])}, undefined]), ...overrideResponse})
...
export const getDeleteMockHandler = (overrideResponse?: DataDataset | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => Promise<DataDataset> | DataDataset), options?: RequestHandlerOptions) => {
  return http.delete('*/v2/dataset/:repo', async (info) => {await delay(1000);
...
export const getSearchRecordsMockHandler = (overrideResponse?: DataDataset | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<DataDataset> | DataDataset), options?: RequestHandlerOptions) => {
  return http.get('*/v2/dataset/:repo', async (info) => {await delay(1000);
...
export const getCreateMockHandler = (overrideResponse?: Create200 | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<Create200> | Create200), options?: RequestHandlerOptions) => {
  return http.post('*/v2/dataset/:repo', async (info) => {await delay(1000);
...
export const getLocateRecordsMockHandler = (overrideResponse?: LocateRecords200 | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<LocateRecords200> | LocateRecords200), options?: RequestHandlerOptions) => {
  return http.get('*/v2/dataset/:repo/:id', async (info) => {await delay(1000);
...
export const getUpdateMockHandler = (overrideResponse?: Update200 | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<Update200> | Update200), options?: RequestHandlerOptions) => {
  return http.patch('*/v2/dataset/:repo/:id', async (info) => {await delay(1000);
...
export const getUpdate2MockHandler = (overrideResponse?: Update2200 | ((info: Parameters<Parameters<typeof http.put>[1]>[0]) => Promise<Update2200> | Update2200), options?: RequestHandlerOptions) => {
  return http.put('*/v2/dataset/:repo/:id', async (info) => {await delay(1000);
