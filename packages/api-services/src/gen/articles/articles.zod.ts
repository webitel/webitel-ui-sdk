...
export const ListArticlesResponse = zod.object({
  ...
  "hasChildren": zod.boolean().optional().describe('Indicates that the article has children.'),
  ...
  "pinned": zod.boolean().optional().describe('Indicates that the article is pinned on the top of list.'),
  "spaceId": zod.string().optional().describe('Space ID associated with.'),
  "state": zod.boolean().optional().describe('Indicates the state of the article.'),
...
})).optional().describe('Article dataset page.'),
...
export const CreateArticleBody = zod.object({
  ...
  "parentArticle": zod.string().optional().describe('The parent article ID.'),
  "pinned": zod.boolean().optional().describe('Indicates that the article is pinned on the top of list.'),
  "spaceId": zod.string().optional().describe('[VALUE]: --------------------------------------\nSpace ID associated with.'),
  "state": zod.boolean().optional().describe('Indicates if article is active and actual.'),
  "text": zod.string().optional().describe('The text content of the article.'),
  "title": zod.string().optional().describe('The title of the article.')
...
})).optional().describe('Attachment dataset page.'),
  "next": zod.boolean().optional(),
  "page": zod.number().optional().describe('The page number of the partial result.')
})
...
export const ListArticles2Response = zod.object({
  "data": zod.array(zod.object({
  "tags": zod.array(zod.string()).optional().describe('Tags associated with the article.'),
  "createdAt": zod.string().optional().describe('The user who created this Field.'),
  "createdBy": zod.object({
...
export const LocateArticleParams = zod.object({
  "space_id": zod.string().describe('Space ID associated with.'),
  "etag": zod.string().describe('Unique Article link IDentifier.\nAccept: `etag` (obsolete+) or `id`.')
})
