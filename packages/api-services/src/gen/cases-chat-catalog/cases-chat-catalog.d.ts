...
getCasesChatCatalog: (axiosInstance?: AxiosInstance) => {
    casesChatCatalogGetCaseChatHistory: (caseId: string, chatId: string, params?: CasesChatCatalogGetCaseChatHistoryParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<WebitelChatChatMessages>>;
};
