...
export const casesChatCatalogGetCaseChatHistoryResponseMessagesItemKeyboardButtonsItemRowItemShareDefault = `phone`;
...
export const CasesChatCatalogGetCaseChatHistoryResponse = zod.object({
  ...
  "share": zod.enum(['phone', 'email', 'contact', 'location']).default(casesChatCatalogGetCaseChatHistoryResponseMessagesItemKeyboardButtonsItemRowItemShareDefault).describe('- phone: Phone Number\n - email: Email Address\n - contact: General Form\n - location: Current Location'),
