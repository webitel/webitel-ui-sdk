...
export const getSearchQueueReportGeneralResponseMock = (
	...
	items: faker.helpers.arrayElement([
		Array.from(
			...
			avgAhtSec: faker.helpers.arrayElement([faker.number.float(), undefined]),
			avgAsaSec: faker.helpers.arrayElement([faker.number.float(), undefined]),
			avgAwtSec: faker.helpers.arrayElement([faker.number.float(), undefined]),
			avgWrapSec: faker.helpers.arrayElement([faker.number.float(), undefined]),
			bridged: faker.helpers.arrayElement([faker.number.float(), undefined]),
			count: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
			...
			sl20: faker.helpers.arrayElement([faker.number.float(), undefined]),
			sl30: faker.helpers.arrayElement([faker.number.float(), undefined]),
			sumBillSec: faker.helpers.arrayElement([faker.number.float(), undefined]),
			team: faker.helpers.arrayElement([
				{
					id: faker.helpers.arrayElement([
						faker.number.int({ min: undefined, max: undefined }),
