...
export const DeleteType2Response = zod.object({
  ...
  "kind": zod.enum(['none', 'list', 'bool', 'int', 'int32', 'int64', 'uint', 'uint32', 'uint64', 'float', 'float32', 'float64', 'binary', 'lookup', 'string', 'richtext', 'datetime', 'duration']).default(deleteType2ResponseDataItemFieldsItemKindDefault).describe('Kind of primitive data types.\n\n - none: option allow_alias = true;\n - list: [array]\n - int: int32\n - uint: uint32\n - float: float32\n - datetime: date &| time'),
  "lookup": zod.object({
...
export const searchTypeExtensionsQuerySortItemRegExp = new RegExp('^[+|-|!]?\\w+$');
...
export const SearchTypeExtensionsQueryParams = zod.object({
  ...
  "sort": zod.array(zod.string().regex(searchTypeExtensionsQuerySortItemRegExp)).optional().describe('Sort result dataset of records by fields.\n```\nsort ::= *( ORDER name )\n\nORDER  = ASC / DESC\nDESC   = \"-\" / \"!\"\nASC    = [ \"+\" ]   ; Default\n```\n\nFields available\n\n- `id`(seq)\n- `domain`{name}\n- `created_at`\n- `created_by`{name}\n- `updated_at`\n- `updated_by`{name}\n\nUse ?fields=`field.sort()` option to sort Edge fields.'),
...
export const SearchTypeExtensionsResponse = zod.object({
  "data": zod.array(zod.object({
  "about": zod.string().optional().describe('Optional. Short description.'),
  "administered": zod.boolean().optional(),
  "createdAt": zod.string().optional(),
  ...
  "kind": zod.enum(['none', 'list', 'bool', 'int', 'int32', 'int64', 'uint', 'uint32', 'uint64', 'float', 'float32', 'float64', 'binary', 'lookup', 'string', 'richtext', 'datetime', 'duration']).default(searchTypeExtensionsResponseDataItemFieldsItemKindDefault).describe('Kind of primitive data types.\n\n - none: option allow_alias = true;\n - list: [array]\n - int: int32\n - uint: uint32\n - float: float32\n - datetime: date &| time'),
  "lookup": zod.object({
  "display": zod.string().optional().describe('[Readonly]. Display dataset field.\n(lookup).{`name`} value relation.'),
  "name": zod.string().optional().describe('[Readonly]. Dataset title.'),
  "path": zod.string().optional().describe('[Required]. Reference dataset relative path\ne.g.: \"contacts\", \"dictionaries/cities\".\n(lookup).{`type`} value relation.'),
...
export const DeleteTypeExtensionsResponse = zod.object({
  "data": zod.array(zod.object({
  "about": zod.string().optional().describe('Optional. Short description.'),
  "administered": zod.boolean().optional(),
  "createdAt": zod.string().optional(),
  ...
  "kind": zod.enum(['none', 'list', 'bool', 'int', 'int32', 'int64', 'uint', 'uint32', 'uint64', 'float', 'float32', 'float64', 'binary', 'lookup', 'string', 'richtext', 'datetime', 'duration']).default(deleteTypeExtensionsResponseDataItemFieldsItemKindDefault).describe('Kind of primitive data types.\n\n - none: option allow_alias = true;\n - list: [array]\n - int: int32\n - uint: uint32\n - float: float32\n - datetime: date &| time'),
  "lookup": zod.object({
  "display": zod.string().optional().describe('[Readonly]. Display dataset field.\n(lookup).{`name`} value relation.'),
  "name": zod.string().optional().describe('[Readonly]. Dataset title.'),
  "path": zod.string().optional().describe('[Required]. Reference dataset relative path\ne.g.: \"contacts\", \"dictionaries/cities\".\n(lookup).{`type`} value relation.'),
...
export const LocateTypeExtensionsResponse = zod.object({
  "about": zod.string().optional().describe('Optional. Short description.'),
  "administered": zod.boolean().optional(),
  "createdAt": zod.string().optional(),
  "createdBy": zod.object({
  ...
  "kind": zod.enum(['none', 'list', 'bool', 'int', 'int32', 'int64', 'uint', 'uint32', 'uint64', 'float', 'float32', 'float64', 'binary', 'lookup', 'string', 'richtext', 'datetime', 'duration']).default(locateTypeExtensionsResponseFieldsItemKindDefault).describe('Kind of primitive data types.\n\n - none: option allow_alias = true;\n - list: [array]\n - int: int32\n - uint: uint32\n - float: float32\n - datetime: date &| time'),
  "lookup": zod.object({
  "display": zod.string().optional().describe('[Readonly]. Display dataset field.\n(lookup).{`name`} value relation.'),
  "name": zod.string().optional().describe('[Readonly]. Dataset title.'),
  "path": zod.string().optional().describe('[Required]. Reference dataset relative path\ne.g.: \"contacts\", \"dictionaries/cities\".\n(lookup).{`type`} value relation.'),
...
export const CreateTypeExtensionsParams = zod.object({
  "repo": zod.string().describe('SUPER `types.repo` to extend, e.g.: `contacts`.\nLookup: GET /types?extendable=true')
})
...
export const CreateTypeExtensionsBody = zod.object({
  ...
  "kind": zod.enum(['none', 'list', 'bool', 'int', 'int32', 'int64', 'uint', 'uint32', 'uint64', 'float', 'float32', 'float64', 'binary', 'lookup', 'string', 'richtext', 'datetime', 'duration']).default(createTypeExtensionsBodyFieldsItemKindDefault).describe('Kind of primitive data types.\n\n - none: option allow_alias = true;\n - list: [array]\n - int: int32\n - uint: uint32\n - float: float32\n - datetime: date &| time'),
  "lookup": zod.object({
  "display": zod.string().optional().describe('[Readonly]. Display dataset field.\n(lookup).{`name`} value relation.'),
  "name": zod.string().optional().describe('[Readonly]. Dataset title.'),
  "path": zod.string().optional().describe('[Required]. Reference dataset relative path\ne.g.: \"contacts\", \"dictionaries/cities\".\n(lookup).{`type`} value relation.'),
  ...
  "indices": zod.record(zod.string(), zod.object({
  "fields": zod.array(zod.string()).optional().describe('A set of [struct.fields.id] to INDEX within [type] dataset.'),
  "include": zod.array(zod.string()).optional().describe('A set of [struct.fields.id] to INCLUDE beside the [fields] index.'),
  "unique": zod.boolean().optional().describe('Indicates whether set of [fields] MUST be UNIQUE within [type].')
}).describe('INDEX [struct.fields].')).optional()
})

export const createTypeExtensionsResponseFieldsItemKindDefault = `none`;

export const CreateTypeExtensionsResponse = zod.object({
  "about": zod.string().optional().describe('Optional. Short description.'),
  "administered": zod.boolean().optional(),
  "createdAt": zod.string().optional(),
  "createdBy": zod.object({
  ...
  "kind": zod.enum(['none', 'list', 'bool', 'int', 'int32', 'int64', 'uint', 'uint32', 'uint64', 'float', 'float32', 'float64', 'binary', 'lookup', 'string', 'richtext', 'datetime', 'duration']).default(createTypeExtensionsResponseFieldsItemKindDefault).describe('Kind of primitive data types.\n\n - none: option allow_alias = true;\n - list: [array]\n - int: int32\n - uint: uint32\n - float: float32\n - datetime: date &| time'),
  "lookup": zod.object({
  "display": zod.string().optional().describe('[Readonly]. Display dataset field.\n(lookup).{`name`} value relation.'),
  "name": zod.string().optional().describe('[Readonly]. Dataset title.'),
  "path": zod.string().optional().describe('[Required]. Reference dataset relative path\ne.g.: \"contacts\", \"dictionaries/cities\".\n(lookup).{`type`} value relation.'),
...
export const UpdateTypeExtensionsBody = zod.object({
  ...
  "kind": zod.enum(['none', 'list', 'bool', 'int', 'int32', 'int64', 'uint', 'uint32', 'uint64', 'float', 'float32', 'float64', 'binary', 'lookup', 'string', 'richtext', 'datetime', 'duration']).default(updateTypeExtensionsBodyFieldsItemKindDefault).describe('Kind of primitive data types.\n\n - none: option allow_alias = true;\n - list: [array]\n - int: int32\n - uint: uint32\n - float: float32\n - datetime: date &| time'),
  "lookup": zod.object({
  "display": zod.string().optional().describe('[Readonly]. Display dataset field.\n(lookup).{`name`} value relation.'),
  "name": zod.string().optional().describe('[Readonly]. Dataset title.'),
  "path": zod.string().optional().describe('[Required]. Reference dataset relative path\ne.g.: \"contacts\", \"dictionaries/cities\".\n(lookup).{`type`} value relation.'),
...
export const UpdateTypeExtensionsResponse = zod.object({
  "about": zod.string().optional().describe('Optional. Short description.'),
  "administered": zod.boolean().optional(),
  "createdAt": zod.string().optional(),
  "createdBy": zod.object({
  ...
  "kind": zod.enum(['none', 'list', 'bool', 'int', 'int32', 'int64', 'uint', 'uint32', 'uint64', 'float', 'float32', 'float64', 'binary', 'lookup', 'string', 'richtext', 'datetime', 'duration']).default(updateTypeExtensionsResponseFieldsItemKindDefault).describe('Kind of primitive data types.\n\n - none: option allow_alias = true;\n - list: [array]\n - int: int32\n - uint: uint32\n - float: float32\n - datetime: date &| time'),
  "lookup": zod.object({
  "display": zod.string().optional().describe('[Readonly]. Display dataset field.\n(lookup).{`name`} value relation.'),
  "name": zod.string().optional().describe('[Readonly]. Dataset title.'),
  "path": zod.string().optional().describe('[Required]. Reference dataset relative path\ne.g.: \"contacts\", \"dictionaries/cities\".\n(lookup).{`type`} value relation.'),
