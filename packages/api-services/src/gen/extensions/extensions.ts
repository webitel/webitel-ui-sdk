...
const deleteType2 = <TData = AxiosResponse<DataStructList>>(
    params?: DeleteType2Params, options?: AxiosRequestConfig
 ): Promise<TData> => {
...
const searchTypeExtensions = <TData = AxiosResponse<DataStructList>>(
    params?: SearchTypeExtensionsParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
...
const deleteTypeExtensions = <TData = AxiosResponse<DataStructList>>(
    repo: string[],
    params?: DeleteTypeExtensionsParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axiosInstance.delete(
...
const createTypeExtensions = <TData = AxiosResponse<ProtodataStruct>>(
    repo: string,
    dataInputExtension: DataInputExtension, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axiosInstance.post(
      `/types/extensions/${repo}`,
      dataInputExtension,options
    );
  }
/**
 * returns (Extension) {
...
const updateTypeExtensions = <TData = AxiosResponse<ProtodataStruct>>(
    ...
    return axiosInstance.put(
      ...
      dataInputExtension,options
            ...
            // --- footer start
            return {deleteType2,searchTypeExtensions,deleteTypeExtensions,locateTypeExtensions,createTypeExtensions,updateTypeExtensions}};
