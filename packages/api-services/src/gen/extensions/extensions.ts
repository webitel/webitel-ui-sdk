	...
	getExtensions =
		...
		(axiosInstance: AxiosInstance = axios) => {
			...
			const deleteType2 = (
				...
				return axiosInstance.delete(`/types/extensions`, {
					...options,
					params: {
						...params,
						...options?.params,
			 ...
			 */
			const searchTypeExtensions = (
				params?: SearchTypeExtensionsParams,
				options?: AxiosRequestConfig,
			): Promise<AxiosResponse<DataStructList>> => {
				return axiosInstance.get(`/types/extensions`, {
					...options,
					params: {
						...params,
						...options?.params,
			 ...
			 * @summary Delete extension for types.
			 */
			const deleteTypeExtensions = (
				repo: string[],
				params?: DeleteTypeExtensionsParams,
				options?: AxiosRequestConfig,
			): Promise<AxiosResponse<DataStructList>> => {
				return axiosInstance.delete(`/types/extensions/${repo}`, {
					...options,
					params: {
						...params,
						...options?.params,
			 ...
			 */
			const locateTypeExtensions = (
				repo: string,
				options?: AxiosRequestConfig,
			): Promise<AxiosResponse<ProtoDataStruct>> => {
				return axiosInstance.get(`/types/extensions/${repo}`, options);
			};
			/**
			 * returns (Extension) {
			 * @summary Create type extension.
			 */
			const createTypeExtensions = (
				repo: string,
