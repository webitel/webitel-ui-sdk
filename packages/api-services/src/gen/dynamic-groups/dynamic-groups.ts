 ...
 */
const listDynamicGroups = <TData = AxiosResponse<ContactsDynamicGroupList>>(
    params?: ListDynamicGroupsParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
...
const createDynamicGroup = <TData = AxiosResponse<ContactsDynamicGroup>>(
    contactsCreateDynamicGroupRequest: ContactsCreateDynamicGroupRequest, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axiosInstance.post(
      `/contacts/groups/dynamic`,
      contactsCreateDynamicGroupRequest,options
    );
  }
/**
...
const deleteDynamicGroup = <TData = AxiosResponse<ContactsDynamicGroup>>(
    ...
    return axiosInstance.delete(
      `/contacts/groups/${id}/dynamic`,options
    );
  }
/**
 * @summary Locate a dynamic group by ID
 */
const locateDynamicGroup = <TData = AxiosResponse<ContactsLocateDynamicGroupResponse>>(
    id: string,
    params?: LocateDynamicGroupParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axiosInstance.get(
...
const updateDynamicGroup2 = <TData = AxiosResponse<ContactsDynamicGroup>>(
    id: string,
    contactsDynamicGroupInput: ContactsDynamicGroupInput, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axiosInstance.patch(
      `/contacts/groups/${id}/dynamic`,
      contactsDynamicGroupInput,options
    );
  }
/**
 * @summary Update an existing dynamic group
...
const updateDynamicGroup = <TData = AxiosResponse<ContactsDynamicGroup>>(
    ...
    return axiosInstance.put(
      ...
      contactsDynamicGroupInput,options
            ...
            // --- footer start
            return {listDynamicGroups,createDynamicGroup,deleteDynamicGroup,locateDynamicGroup,updateDynamicGroup2,updateDynamicGroup}};
