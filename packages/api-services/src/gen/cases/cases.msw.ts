...
export const getSearchCasesResponseMock = (
	overrideResponse: Partial<Extract<WebitelCasesCaseList, object>> = {},
): WebitelCasesCaseList => ({
	items: faker.helpers.arrayElement([
		Array.from(
			...
			custom: faker.helpers.arrayElement([
				{},
				undefined,
			]),
...
export const getCreateCaseResponseMock = (
	overrideResponse: Partial<Extract<WebitelCasesCase, object>> = {},
): WebitelCasesCase => ({
	assignee: faker.helpers.arrayElement([
		{
			id: faker.helpers.arrayElement([
...
export const getExportCasesResponseMock = (
	overrideResponse: Partial<Extract<ExportCases200, object>> = {},
): ExportCases200 => ({
...
export const getUpdateCase2ResponseMock = (
	overrideResponse: Partial<
		Extract<WebitelCasesUpdateCaseResponse, object>
	> = {},
): WebitelCasesUpdateCaseResponse => ({
