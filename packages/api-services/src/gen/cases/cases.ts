	...
	getCases =
		...
		(axiosInstance: AxiosInstance = axios) => {
			...
			const deleteCase = (
				...
				return axiosInstance.delete(`/cases/${etag}`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const locateCase = (
				...
				return axiosInstance.get(`/cases/${etag}`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const updateCase2 = (
				...
				return axiosInstance.patch(`/cases/input.etag}`, updateCase2Body, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const updateCase = (
				...
				return axiosInstance.put(`/cases/input.etag}`, updateCaseBody, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const searchCases2 = (
				...
				return axiosInstance.get(`/contacts/${contactId}/cases`, {
					...options,
					params: {
						...params,
						...options?.params,
