	...
	getSlas =
		...
		(axiosInstance: AxiosInstance = axios) => {
			...
			const listSLAs = (
				...
				return axiosInstance.get(`/cases/slas`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const createSLA = (
				...
				return axiosInstance.post(`/cases/slas`, webitelCasesInputSLABody, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const deleteSLA = (
				...
				return axiosInstance.delete(`/cases/slas/${id}`, options);
			};
			/**
			...
			const locateSLA = (
				...
				return axiosInstance.get(`/cases/slas/${id}`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const updateSLA2 = (
				...
				return axiosInstance.patch(`/cases/slas/${id}`, webitelCasesInputSLA, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const updateSLA = (
				...
				return axiosInstance.put(`/cases/slas/${id}`, webitelCasesInputSLA, {
					...options,
					params: {
						...params,
						...options?.params,
