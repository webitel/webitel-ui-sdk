...
export const getListSLAsResponseMock = (
	overrideResponse: Partial<Extract<WebitelCasesSLAList, object>> = {},
): WebitelCasesSLAList => ({
...
export const getCreateSLAResponseMock = (
	overrideResponse: Partial<Extract<WebitelCasesSLA, object>> = {},
): WebitelCasesSLA => ({
	calendar: faker.helpers.arrayElement([
		{
			id: faker.helpers.arrayElement([
...
export const getLocateSLAResponseMock = (
	overrideResponse: Partial<
		Extract<WebitelCasesLocateSLAResponse, object>
	> = {},
): WebitelCasesLocateSLAResponse => ({
