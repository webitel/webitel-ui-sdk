...
export const getOAuth2FederationSearchOAuthServiceResponseMock = (
	...
	items: faker.helpers.arrayElement([
		Array.from(
			...
			authUrl: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
			...
			clientId: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
			...
			logo: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
			...
			tokenUrl: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
			type: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
...
export const getOAuth2FederationCreateOAuthServiceResponseMock = (
	...
	clientId: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
	clientSecret: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
	createdAt: faker.helpers.arrayElement([
		faker.number.int({ min: undefined, max: undefined }),
		undefined,
	]),
	...
	discoveryUrl: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
	domain: faker.helpers.arrayElement([
		{
			id: faker.helpers.arrayElement([
				faker.number.int({ min: undefined, max: undefined }),
	...
	userinfoUrl: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
	...overrideResponse,
});
