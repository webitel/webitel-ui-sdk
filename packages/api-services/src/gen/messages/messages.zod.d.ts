 ...
 */
export declare const MessagesServiceBroadcastMessageBody: any;
export declare const MessagesServiceBroadcastMessageResponse: any;
/**
 * @summary Query of external chat customers
 */
export declare const CatalogGetCustomersQueryParams: any;
export declare const CatalogGetCustomersResponse: any;
/**
 ...
 */
export declare const CatalogGetMembersParams: any;
export declare const CatalogGetMembersQueryParams: any;
export declare const CatalogGetMembersResponse: any;
/**
