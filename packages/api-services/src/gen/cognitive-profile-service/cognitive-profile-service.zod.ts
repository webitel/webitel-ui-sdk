...
export const searchCognitiveProfileResponseItemsItemProviderDefault = `DefaultProvider`;
export const searchCognitiveProfileResponseItemsItemServiceDefault = `DefaultService`;
...
export const CreateCognitiveProfileBody = zod
	.object({
		...
		provider: zod
			...
			.default(createCognitiveProfileBodyProviderDefault),
		service: zod
			.enum([
				'DefaultService',
				'STT',
			...
			.default(createCognitiveProfileBodyServiceDefault),
	})
