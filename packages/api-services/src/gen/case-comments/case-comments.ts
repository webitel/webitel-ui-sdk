	...
	getCaseComments =
		...
		(axiosInstance: AxiosInstance = axios) => {
			...
			const deleteComment = (
				...
				return axiosInstance.delete(`/cases/comments/${etag}`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const locateComment = (
				...
				return axiosInstance.get(`/cases/comments/${etag}`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const listComments = (
				...
				return axiosInstance.get(`/cases/${caseEtag}/comments`, {
					...options,
					params: {
						...params,
						...options?.params,
