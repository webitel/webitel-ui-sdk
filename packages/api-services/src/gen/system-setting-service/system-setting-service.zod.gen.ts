...
export const searchSystemSettingResponse = zod.object({
  ...
  "name": zod.enum(['empty_system_settings_name', 'enable_omnichannel', 'member_chunk_size', 'amd_cancel_not_human', 'scheme_version_limit', 'enable_2fa', 'export_settings', 'search_number_length', 'chat_ai_connection', 'password_reg_exp', 'password_validation_text', 'autolink_call_to_contact', 'period_to_playback_records', 'is_fulltext_search_enabled', 'wbt_hide_contact', 'show_full_contact', 'call_end_sound_notification', 'call_end_push_notification', 'chat_end_sound_notification', 'chat_end_push_notification', 'task_end_sound_notification', 'task_end_push_notification', 'push_notification_timeout', 'labels_to_limit_contacts', 'autolink_mail_to_contact', 'new_message_sound_notification', 'new_chat_sound_notification', 'screenshot_interval', 'password_expiry_days', 'password_min_length', 'password_categories', 'password_contains_username', 'password_warning_days', 'default_password']).default(searchSystemSettingResponseItemsItemNameDefault)
})).optional(),
...
export const createSystemSettingBody = zod.object({
  "name": zod.enum(['empty_system_settings_name', 'enable_omnichannel', 'member_chunk_size', 'amd_cancel_not_human', 'scheme_version_limit', 'enable_2fa', 'export_settings', 'search_number_length', 'chat_ai_connection', 'password_reg_exp', 'password_validation_text', 'autolink_call_to_contact', 'period_to_playback_records', 'is_fulltext_search_enabled', 'wbt_hide_contact', 'show_full_contact', 'call_end_sound_notification', 'call_end_push_notification', 'chat_end_sound_notification', 'chat_end_push_notification', 'task_end_sound_notification', 'task_end_push_notification', 'push_notification_timeout', 'labels_to_limit_contacts', 'autolink_mail_to_contact', 'new_message_sound_notification', 'new_chat_sound_notification', 'screenshot_interval', 'password_expiry_days', 'password_min_length', 'password_categories', 'password_contains_username', 'password_warning_days', 'default_password']).default(createSystemSettingBodyNameDefault)
})
...
export const createSystemSettingResponse = zod.object({
  "id": zod.number().optional(),
  "name": zod.enum(['empty_system_settings_name', 'enable_omnichannel', 'member_chunk_size', 'amd_cancel_not_human', 'scheme_version_limit', 'enable_2fa', 'export_settings', 'search_number_length', 'chat_ai_connection', 'password_reg_exp', 'password_validation_text', 'autolink_call_to_contact', 'period_to_playback_records', 'is_fulltext_search_enabled', 'wbt_hide_contact', 'show_full_contact', 'call_end_sound_notification', 'call_end_push_notification', 'chat_end_sound_notification', 'chat_end_push_notification', 'task_end_sound_notification', 'task_end_push_notification', 'push_notification_timeout', 'labels_to_limit_contacts', 'autolink_mail_to_contact', 'new_message_sound_notification', 'new_chat_sound_notification', 'screenshot_interval', 'password_expiry_days', 'password_min_length', 'password_categories', 'password_contains_username', 'password_warning_days', 'default_password']).default(createSystemSettingResponseNameDefault)
})
...
export const deleteSystemSettingResponse = zod.object({
  "id": zod.number().optional(),
  "name": zod.enum(['empty_system_settings_name', 'enable_omnichannel', 'member_chunk_size', 'amd_cancel_not_human', 'scheme_version_limit', 'enable_2fa', 'export_settings', 'search_number_length', 'chat_ai_connection', 'password_reg_exp', 'password_validation_text', 'autolink_call_to_contact', 'period_to_playback_records', 'is_fulltext_search_enabled', 'wbt_hide_contact', 'show_full_contact', 'call_end_sound_notification', 'call_end_push_notification', 'chat_end_sound_notification', 'chat_end_push_notification', 'task_end_sound_notification', 'task_end_push_notification', 'push_notification_timeout', 'labels_to_limit_contacts', 'autolink_mail_to_contact', 'new_message_sound_notification', 'new_chat_sound_notification', 'screenshot_interval', 'password_expiry_days', 'password_min_length', 'password_categories', 'password_contains_username', 'password_warning_days', 'default_password']).default(deleteSystemSettingResponseNameDefault)
})
...
export const readSystemSettingResponse = zod.object({
  "id": zod.number().optional(),
  "name": zod.enum(['empty_system_settings_name', 'enable_omnichannel', 'member_chunk_size', 'amd_cancel_not_human', 'scheme_version_limit', 'enable_2fa', 'export_settings', 'search_number_length', 'chat_ai_connection', 'password_reg_exp', 'password_validation_text', 'autolink_call_to_contact', 'period_to_playback_records', 'is_fulltext_search_enabled', 'wbt_hide_contact', 'show_full_contact', 'call_end_sound_notification', 'call_end_push_notification', 'chat_end_sound_notification', 'chat_end_push_notification', 'task_end_sound_notification', 'task_end_push_notification', 'push_notification_timeout', 'labels_to_limit_contacts', 'autolink_mail_to_contact', 'new_message_sound_notification', 'new_chat_sound_notification', 'screenshot_interval', 'password_expiry_days', 'password_min_length', 'password_categories', 'password_contains_username', 'password_warning_days', 'default_password']).default(readSystemSettingResponseNameDefault)
})
...
export const patchSystemSettingResponse = zod.object({
  "id": zod.number().optional(),
  "name": zod.enum(['empty_system_settings_name', 'enable_omnichannel', 'member_chunk_size', 'amd_cancel_not_human', 'scheme_version_limit', 'enable_2fa', 'export_settings', 'search_number_length', 'chat_ai_connection', 'password_reg_exp', 'password_validation_text', 'autolink_call_to_contact', 'period_to_playback_records', 'is_fulltext_search_enabled', 'wbt_hide_contact', 'show_full_contact', 'call_end_sound_notification', 'call_end_push_notification', 'chat_end_sound_notification', 'chat_end_push_notification', 'task_end_sound_notification', 'task_end_push_notification', 'push_notification_timeout', 'labels_to_limit_contacts', 'autolink_mail_to_contact', 'new_message_sound_notification', 'new_chat_sound_notification', 'screenshot_interval', 'password_expiry_days', 'password_min_length', 'password_categories', 'password_contains_username', 'password_warning_days', 'default_password']).default(patchSystemSettingResponseNameDefault)
})
...
export const updateSystemSettingResponse = zod.object({
  "id": zod.number().optional(),
  "name": zod.enum(['empty_system_settings_name', 'enable_omnichannel', 'member_chunk_size', 'amd_cancel_not_human', 'scheme_version_limit', 'enable_2fa', 'export_settings', 'search_number_length', 'chat_ai_connection', 'password_reg_exp', 'password_validation_text', 'autolink_call_to_contact', 'period_to_playback_records', 'is_fulltext_search_enabled', 'wbt_hide_contact', 'show_full_contact', 'call_end_sound_notification', 'call_end_push_notification', 'chat_end_sound_notification', 'chat_end_push_notification', 'task_end_sound_notification', 'task_end_push_notification', 'push_notification_timeout', 'labels_to_limit_contacts', 'autolink_mail_to_contact', 'new_message_sound_notification', 'new_chat_sound_notification', 'screenshot_interval', 'password_expiry_days', 'password_min_length', 'password_categories', 'password_contains_username', 'password_warning_days', 'default_password']).default(updateSystemSettingResponseNameDefault)
})
