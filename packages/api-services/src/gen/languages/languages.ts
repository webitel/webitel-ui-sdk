...
const delContactLanguages = <TData = AxiosResponse<ContactsLanguageList>>(
    contactId: string,
    params: DelContactLanguagesParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.delete(
...
const getContactLanguages = <TData = AxiosResponse<ContactsLanguageList>>(
    contactId: string,
    params?: GetContactLanguagesParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
      `/contacts/${contactId}/languages`,{
    ...options,
...
const addContactLanguages = <TData = AxiosResponse<ContactsLanguageList>>(
    ...
    params?: AddContactLanguagesParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/contacts/${contactId}/languages`,
      contactsInputLanguage,{
...
const setContactLanguages = <TData = AxiosResponse<ContactsLanguageList>>(
    contactId: string,
    contactsInputLanguage: ContactsInputLanguage[],
    params?: SetContactLanguagesParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.put(
      `/contacts/${contactId}/languages`,
      contactsInputLanguage,{
...
const delContactLanguage = <TData = AxiosResponse<ContactsLanguage>>(
    contactId: string,
    etag: string,
    params?: DelContactLanguageParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.delete(
...
const setContactLanguage2 = <TData = AxiosResponse<ContactsLanguageList>>(
    ...
    params?: SetContactLanguage2Params, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.patch(
      `/contacts/${contactId}/languages/${etag}`,
      setContactLanguage2Body,{
...
const setContactLanguage = <TData = AxiosResponse<ContactsLanguageList>>(
    ...
    params?: SetContactLanguageParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.put(
      `/contacts/${contactId}/languages/${etag}`,
      setContactLanguageBody,{
    ...options,
        params: {...params, ...options?.params},}
            ...
            // --- footer start
            return {delContactLanguages,getContactLanguages,addContactLanguages,setContactLanguages,delContactLanguage,setContactLanguage2,setContactLanguage}};
