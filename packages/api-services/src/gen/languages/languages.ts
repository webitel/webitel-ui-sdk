...
export const // --- title start
	getLanguages =
		...
		(axiosInstance: AxiosInstance = axios) => {
			 ...
			 */
			const delContactLanguages = (
				contactId: string,
				params: DelContactLanguagesParams,
				options?: AxiosRequestConfig,
			): Promise<AxiosResponse<ContactsLanguageList>> => {
				return axiosInstance.delete(`/contacts/${contactId}/languages`, {
					...options,
					params: {
						...params,
						...options?.params,
			 ...
			 */
			const getContactLanguages = (
				contactId: string,
				params?: GetContactLanguagesParams,
				options?: AxiosRequestConfig,
			): Promise<AxiosResponse<ContactsLanguageList>> => {
				return axiosInstance.get(`/contacts/${contactId}/languages`, {
					...options,
					params: {
						...params,
						...options?.params,
