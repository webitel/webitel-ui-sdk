	...
	getEmails =
		...
		(axiosInstance: AxiosInstance = axios) => {
			...
			const deleteEmails = <TData = AxiosResponse<ContactsEmailList>>(
				...
				return axiosInstance.delete(`/contacts/${contactId}/emails`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const listEmails = <TData = AxiosResponse<ContactsEmailList>>(
				...
				return axiosInstance.get(`/contacts/${contactId}/emails`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const deleteEmail = <TData = AxiosResponse<ContactsEmailAddress>>(
				...
				return axiosInstance.delete(`/contacts/${contactId}/emails/${etag}`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const locateEmail = <TData = AxiosResponse<ContactsEmailAddress>>(
				...
				return axiosInstance.get(`/contacts/${contactId}/emails/${etag}`, {
					...options,
					params: {
						...params,
						...options?.params,
