	...
	getDevices =
		...
		(axiosInstance: AxiosInstance = axios) => {
			...
			const deleteDevice2 = (
				...
				return axiosInstance.delete(`/devices`, {
			...
			const createDevice = (
				...
				return axiosInstance.post(`/devices`, apiDevice, options);
			};
			const updateDevice2 = (
				...
				return axiosInstance.patch(`/devices/device.id}`, updateDevice2Body, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const updateDevice = (
				...
				return axiosInstance.put(`/devices/device.id}`, updateDeviceBody, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const listRegistrations = (
				...
				return axiosInstance.get(`/devices/device.id}/registered`, {
					...options,
					params: {
						...params,
						...options?.params,
			 ...
			 * @summary ----- Details (1:M) ----------------------------------------------
			 */
			const searchDeviceAudit = (
				params?: SearchDeviceAuditParams,
				options?: AxiosRequestConfig,
			): Promise<AxiosResponse<ApiDeviceAuditResponse>> => {
				return axiosInstance.get(`/devices/device.id}/users/audit`, {
					...options,
					params: {
						...params,
						...options?.params,
