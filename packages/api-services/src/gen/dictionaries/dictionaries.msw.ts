	...
	type: faker.helpers.arrayElement([
		{
			...
			fields: faker.helpers.arrayElement([
				Array.from(
					...
					always: faker.helpers.arrayElement([
						{},
						undefined,
					]),
					...
					bool: faker.helpers.arrayElement([
						{},
						undefined,
					]),
...
export const getDeleteTypeResponseMock = (
	overrideResponse: Partial<Extract<DataStructList, object>> = {},
): DataStructList => ({
	data: faker.helpers.arrayElement([
		Array.from(
			{
...
export const getLocateTypeResponseMock = (
	overrideResponse: Partial<Extract<ProtoDataStruct, object>> = {},
): ProtoDataStruct => ({
	about: faker.helpers.arrayElement([
		faker.string.alpha({
			length: {
