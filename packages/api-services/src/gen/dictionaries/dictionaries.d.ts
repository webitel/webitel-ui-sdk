...
getDictionaries: (axiosInstance?: AxiosInstance) => {
    ...
    updateData: (repo: string, id: string, updateDataBody: UpdateDataBody, params?: UpdateDataParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<UpdateData200>>;
    updateData2: (repo: string, id: string, updateData2Body: UpdateData2Body, params?: UpdateData2Params, options?: AxiosRequestConfig) => Promise<AxiosResponse<UpdateData2200>>;
    deleteType: (params: DeleteTypeParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataStructList>>;
    searchType: (params?: SearchTypeParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataStructList>>;
    locateType: (repo: string, options?: AxiosRequestConfig) => Promise<AxiosResponse<ProtoDataStruct>>;
    createType: (repo: string, dataInputDictionary: DataInputDictionary, options?: AxiosRequestConfig) => Promise<AxiosResponse<ProtoDataStruct>>;
    updateType: (repo: string, dataInputDictionary: DataInputDictionary, params?: UpdateTypeParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<ProtoDataStruct>>;
};
