...
getUserHelperService: (axiosInstance?: AxiosInstance) => {
    defaultDeviceConfig: (type: string, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineDefaultDeviceConfigResponse>>;
    activityWorkspaceWidget: (params?: ActivityWorkspaceWidgetParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineActivityWorkspaceWidgetResponse>>;
    openedWebSockets: (userId: string[], params?: OpenedWebSocketsParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineListOpenedWebSocket>>;
};
