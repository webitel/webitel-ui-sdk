...
getCaseFiles: (axiosInstance?: AxiosInstance) => {
    listFiles: (caseEtag: string, params?: ListFilesParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<WebitelCasesCaseFileList>>;
    deleteFile: (caseEtag: string, id: string, options?: AxiosRequestConfig) => Promise<AxiosResponse<WebitelCasesFile>>;
};
