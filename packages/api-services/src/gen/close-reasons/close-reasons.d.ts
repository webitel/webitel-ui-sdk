...
export declare const // --- title start
	getCloseReasons: (axiosInstance?: AxiosInstance) => {
		...
		) => Promise<AxiosResponse<WebitelCasesCloseReasonList>>;
		createCloseReason: (
			closeReasonGroupId: string,
			webitelCasesInputCloseReason: WebitelCasesInputCloseReason,
			params?: CreateCloseReasonParams,
			options?: AxiosRequestConfig,
		) => Promise<AxiosResponse<WebitelCasesCloseReason>>;
		deleteCloseReason: (
			closeReasonGroupId: string,
			id: string,
			options?: AxiosRequestConfig,
		...
		locateCloseReason: (
			...
			options?: AxiosRequestConfig,
		) => Promise<AxiosResponse<WebitelCasesLocateCloseReasonResponse>>;
		updateCloseReason2: (
			closeReasonGroupId: string,
			id: string,
			webitelCasesInputCloseReason: WebitelCasesInputCloseReason,
