...
export const contactsChatCatalogGetContactChatHistory2Params = zod.object({
  "contact_id": zod.string().describe('Contact identificator')
})
...
export const contactsChatCatalogGetContactChatHistory2ResponseMessagesItemKeyboardButtonsItemRowItemShareDefault = "phone";

export const contactsChatCatalogGetContactChatHistory2Response = zod.object({
  ...
  "share": zod.enum(['phone', 'email', 'contact', 'location']).default(contactsChatCatalogGetContactChatHistory2ResponseMessagesItemKeyboardButtonsItemRowItemShareDefault).describe('- phone: Phone Number\n - email: Email Address\n - contact: General Form\n - location: Current Location'),
...
export const contactsChatCatalogGetContactChatHistoryParams = zod.object({
  "contact_id": zod.string().describe('Contact identificator'),
...
export const contactsChatCatalogGetContactChatHistoryResponseMessagesItemKeyboardButtonsItemRowItemShareDefault = "phone";

export const contactsChatCatalogGetContactChatHistoryResponse = zod.object({
  "chats": zod.array(zod.object({
  "context": zod.record(zod.string(), zod.string()).optional().describe('Context. Variables.'),
  "dc": zod.string().optional().describe('[D]omain[C]omponent primary ID.'),
  "id": zod.string().optional().describe('Unique identifier for this chat.\n[FROM] Member / Channel ID.\n\n// [TO] Group. Conversation ID.\n string chat_id = 2;'),
  ...
  "row": zod.array(zod.object({
  "code": zod.string().optional().describe('Postback/Callback data.'),
  "share": zod.enum(['phone', 'email', 'contact', 'location']).default(contactsChatCatalogGetContactChatHistoryResponseMessagesItemKeyboardButtonsItemRowItemShareDefault).describe('- phone: Phone Number\n - email: Email Address\n - contact: General Form\n - location: Current Location'),
  "text": zod.string().optional().describe('Caption to display.'),
  "url": zod.string().optional().describe('URL to navigate to ..')
})).optional()
})).optional(),
