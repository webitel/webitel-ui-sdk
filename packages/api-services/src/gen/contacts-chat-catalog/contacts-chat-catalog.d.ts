...
getContactsChatCatalog: (axiosInstance?: AxiosInstance) => {
    contactsChatCatalogGetContactChatHistory2: (contactId: string, params?: ContactsChatCatalogGetContactChatHistory2Params, options?: AxiosRequestConfig) => Promise<AxiosResponse<WebitelChatGetContactChatHistoryResponse>>;
    contactsChatCatalogGetContactChatHistory: (contactId: string, chatId: string, params?: ContactsChatCatalogGetContactChatHistoryParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<WebitelChatGetContactChatHistoryResponse>>;
};
