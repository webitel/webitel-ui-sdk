...
export const ListGroupsQueryParams = zod.object({
  ...
  "type": zod.enum(['GROUP_TYPE_UNSPECIFIED', 'STATIC', 'DYNAMIC']).default(listGroupsQueryTypeDefault).describe('Filter by group type.\n\n - GROUP_TYPE_UNSPECIFIED: Default value\n - STATIC: Static group\n - DYNAMIC: Dynamic group'),
...
export const ListGroupsResponse = zod.object({
  ...
  "description": zod.string().optional().describe('The description of the group.'),
  "enabled": zod.boolean().optional(),
  "id": zod.string().optional().describe('The unique ID of the group. Never changes.'),
  "name": zod.string().optional().describe('The name of the group.'),
  "type": zod.enum(['GROUP_TYPE_UNSPECIFIED', 'STATIC', 'DYNAMIC']).default(listGroupsResponseItemsItemTypeDefault).describe('- GROUP_TYPE_UNSPECIFIED: Default value\n - STATIC: Static group\n - DYNAMIC: Dynamic group'),
...
export const CreateGroupBody = zod.object({
  "description": zod.string().optional().describe('The description of the group.'),
  "enabled": zod.boolean().optional().describe('The enabled status of the group.'),
...
export const CreateGroupResponse = zod.object({
  ...
  "id": zod.string().optional().describe('The unique ID of the group. Never changes.'),
  "name": zod.string().optional().describe('The name of the group.'),
  "type": zod.enum(['GROUP_TYPE_UNSPECIFIED', 'STATIC', 'DYNAMIC']).default(createGroupResponseTypeDefault).describe('- GROUP_TYPE_UNSPECIFIED: Default value\n - STATIC: Static group\n - DYNAMIC: Dynamic group'),
  "updatedAt": zod.string().optional().describe('Timestamp(milli) of the last group update.'),
  "updatedBy": zod.object({
  "id": zod.string().optional().describe('Reference Object unique ID.'),
  "name": zod.string().optional().describe('Reference Object display name.'),
 ...
 */
export const AddContactsToGroupsBody = zod.object({
  "contactIds": zod.array(zod.string()).optional().describe('List of contact IDs to add to the group.'),
  "groupIds": zod.array(zod.string()).optional().describe('The unique ID of the group.')
}).describe('Request message for adding contacts to a group.')

export const AddContactsToGroupsResponse = zod.object({
...
export const RemoveContactsFromGroupQueryParams = zod.object({
  "contactIds": zod.array(zod.string()).optional().describe('List of contact IDs to remove from the group.')
})

export const RemoveContactsFromGroupResponse = zod.object({
  "data": zod.array(zod.object({
  "about": zod.string().optional().describe('BIO. Short description about the Contact person.\nOPTIONAL. Multi-lined text.'),
  "comments": zod.object({
  "data": zod.array(zod.object({
...
export const DeleteGroupResponse = zod.object({
  ...
  "id": zod.string().optional().describe('The unique ID of the group. Never changes.'),
  "name": zod.string().optional().describe('The name of the group.'),
  "type": zod.enum(['GROUP_TYPE_UNSPECIFIED', 'STATIC', 'DYNAMIC']).default(deleteGroupResponseTypeDefault).describe('- GROUP_TYPE_UNSPECIFIED: Default value\n - STATIC: Static group\n - DYNAMIC: Dynamic group'),
  "updatedAt": zod.string().optional().describe('Timestamp(milli) of the last group update.'),
  "updatedBy": zod.object({
  "id": zod.string().optional().describe('Reference Object unique ID.'),
  "name": zod.string().optional().describe('Reference Object display name.'),
...
export const LocateGroupResponse = zod.object({
  "group": zod.object({
  "conditions": zod.array(zod.object({
  "assignee": zod.object({
  "id": zod.string().optional().describe('Reference Object unique ID.'),
  ...
  "id": zod.string().optional().describe('The unique ID of the group. Never changes.'),
  "name": zod.string().optional().describe('The name of the group.'),
  "type": zod.enum(['GROUP_TYPE_UNSPECIFIED', 'STATIC', 'DYNAMIC']).default(locateGroupResponseGroupTypeDefault).describe('- GROUP_TYPE_UNSPECIFIED: Default value\n - STATIC: Static group\n - DYNAMIC: Dynamic group'),
  "updatedAt": zod.string().optional().describe('Timestamp(milli) of the last group update.'),
  "updatedBy": zod.object({
  "id": zod.string().optional().describe('Reference Object unique ID.'),
  "name": zod.string().optional().describe('Reference Object display name.'),
...
export const UpdateGroup2Body = zod.object({
  "description": zod.string().optional().describe('The new description of the group.'),
  "enabled": zod.boolean().optional().describe('The new enabled status of the group.'),
...
export const UpdateGroup2Response = zod.object({
  ...
  "id": zod.string().optional().describe('The unique ID of the group. Never changes.'),
  "name": zod.string().optional().describe('The name of the group.'),
  "type": zod.enum(['GROUP_TYPE_UNSPECIFIED', 'STATIC', 'DYNAMIC']).default(updateGroup2ResponseTypeDefault).describe('- GROUP_TYPE_UNSPECIFIED: Default value\n - STATIC: Static group\n - DYNAMIC: Dynamic group'),
  "updatedAt": zod.string().optional().describe('Timestamp(milli) of the last group update.'),
  "updatedBy": zod.object({
  "id": zod.string().optional().describe('Reference Object unique ID.'),
  "name": zod.string().optional().describe('Reference Object display name.'),
...
export const UpdateGroupResponse = zod.object({
  ...
  "id": zod.string().optional().describe('The unique ID of the group. Never changes.'),
  "name": zod.string().optional().describe('The name of the group.'),
  "type": zod.enum(['GROUP_TYPE_UNSPECIFIED', 'STATIC', 'DYNAMIC']).default(updateGroupResponseTypeDefault).describe('- GROUP_TYPE_UNSPECIFIED: Default value\n - STATIC: Static group\n - DYNAMIC: Dynamic group'),
  "updatedAt": zod.string().optional().describe('Timestamp(milli) of the last group update.'),
  "updatedBy": zod.object({
  "id": zod.string().optional().describe('Reference Object unique ID.'),
  "name": zod.string().optional().describe('Reference Object display name.'),
