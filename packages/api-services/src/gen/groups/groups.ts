...
const listGroups = <TData = AxiosResponse<ContactsGroupList>>(
    params?: ListGroupsParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
...
const createGroup = <TData = AxiosResponse<ContactsGroup>>(
    contactsCreateGroupRequest: ContactsCreateGroupRequest, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axiosInstance.post(
      `/contacts/groups`,
      contactsCreateGroupRequest,options
    );
  }
/**
...
const addContactsToGroups = <TData = AxiosResponse<ContactsContactList>>(
    contactsAddContactsToGroupRequest: ContactsAddContactsToGroupRequest, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axiosInstance.post(
      `/contacts/groups/contacts:attach`,
      contactsAddContactsToGroupRequest,options
    );
  }
/**
 * @summary Remove contacts from a group
 */
const removeContactsFromGroup = <TData = AxiosResponse<ContactsContactList>>(
    groupId: string,
    params?: RemoveContactsFromGroupParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
...
const locateGroup = <TData = AxiosResponse<ContactsLocateGroupResponse>>(
    id: string,
    params?: LocateGroupParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axiosInstance.get(
      `/contacts/groups/${id}`,{
    ...options,
...
const updateGroup2 = <TData = AxiosResponse<ContactsGroup>>(
    id: string,
    contactsInputGroup: ContactsInputGroup, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axiosInstance.patch(
      `/contacts/groups/${id}`,
      contactsInputGroup,options
    );
  }
/**
 * @summary Update an existing group
...
const updateGroup = <TData = AxiosResponse<ContactsGroup>>(
    ...
    return axiosInstance.put(
      ...
      contactsInputGroup,options
            ...
            // --- footer start
            return {listGroups,createGroup,addContactsToGroups,removeContactsFromGroup,deleteGroup,locateGroup,updateGroup2,updateGroup}};
