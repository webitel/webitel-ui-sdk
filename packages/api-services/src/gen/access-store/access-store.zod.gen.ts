...
export const listDefaultAccessQueryParams = zod.object({
  "grantor": zod.array(zod.string()).optional().describe('--- filters ---\n\n[optional] [FROM] each rule owner is any of role(s) id; user -or- role'),
  "grantee": zod.array(zod.string()).optional().describe('[optional] [TO] subject role(s) id; user -or- role'),
  "granted": zod.array(zod.string()).optional().describe('[xrwdxrwd] [R]ecord-[b]ased-[A]ccess-[C]ontrol level check(!)'),
  "q": zod.string().optional().describe('[optional] [TO] subject.name ILIKE ?q=; user -or- role'),
  "fields": zod.array(zod.string()).optional().describe('----- Select Options -------------------------\n\nattributes list'),
