...
export declare const // --- title start
	getForecastCalculationService: (axiosInstance?: AxiosInstance) => {
		...
		) => Promise<AxiosResponse<WfmSearchForecastCalculationResponse>>;
		...
		forecastCalculationServiceUpdateForecastCalculation: (
			...
			options?: AxiosRequestConfig,
		) => Promise<AxiosResponse<WfmUpdateForecastCalculationResponse>>;
	};
