...
export const getUsersReadUser2ResponseMock = (
	...
	user: faker.helpers.arrayElement([
		{
			chatName: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
			...
			license: faker.helpers.arrayElement([
				Array.from(
					...
					prod: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
			...
			totpUrl: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
