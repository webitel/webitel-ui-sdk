...
export const getCreateCallResponseMock = (
	overrideResponse: Partial<Extract<EngineCreateCallResponse, object>> = {},
): EngineCreateCallResponse => ({
...
export const getSearchActiveCallResponseMock = (
	overrideResponse: Partial<Extract<EngineListCall, object>> = {},
): EngineListCall => ({
...
export const getReadCallResponseMock = (
	overrideResponse: Partial<Extract<EngineActiveCall, object>> = {},
): EngineActiveCall => ({
	agent: faker.helpers.arrayElement([
		{
			id: faker.helpers.arrayElement([
...
export const getHoldCallResponseMock = (
	overrideResponse: Partial<Extract<EngineHoldCallResponse, object>> = {},
): EngineHoldCallResponse => ({
	state: faker.helpers.arrayElement([
		faker.string.alpha({
			length: {
...
export const getSearchHistoryCallResponseMock = (
	overrideResponse: Partial<Extract<EngineListHistoryCall, object>> = {},
): EngineListHistoryCall => ({
	items: faker.helpers.arrayElement([
		Array.from(
			{
			...
			files: faker.helpers.arrayElement([
				Array.from(
					...
					type: faker.helpers.arrayElement([
						faker.helpers.arrayElement(Object.values(EngineCallFileType)),
						undefined,
					]),
				})),
				undefined,
			...
			hangupBy: faker.helpers.arrayElement([
				faker.string.alpha({
					length: {
						min: 10,
						max: 20,
			...
			meetingId: faker.helpers.arrayElement([
				faker.string.alpha({
					length: {
						min: 10,
						max: 20,
			...
			toNumber: faker.helpers.arrayElement([
				faker.string.alpha({
					length: {
						min: 10,
						max: 20,
...
export const getAggregateHistoryCallResponseMock = (
	overrideResponse: Partial<Extract<EngineListAggregate, object>> = {},
): EngineListAggregate => ({
	items: faker.helpers.arrayElement([
		Array.from(
			{
...
export const getCreateCallAnnotationResponseMock = (
	overrideResponse: Partial<Extract<EngineCallAnnotation, object>> = {},
): EngineCallAnnotation => ({
	callId: faker.helpers.arrayElement([
		faker.string.alpha({
			length: {
...
export const getPatchHistoryCallResponseMock = (
	overrideResponse: Partial<Extract<EngineHistoryCall, object>> = {},
): EngineHistoryCall => ({
	tags: faker.helpers.arrayElement([
		Array.from(
			{
