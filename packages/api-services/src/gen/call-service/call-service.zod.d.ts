...
export declare const SearchActiveCallQueryParams: zod.ZodObject<
	{
		...
		'answeredAt.from': zod.ZodOptional<zod.ZodString>;
		'answeredAt.to': zod.ZodOptional<zod.ZodString>;
		missed: zod.ZodOptional<zod.ZodBoolean>;
		'storedAt.from': zod.ZodOptional<zod.ZodString>;
		'storedAt.to': zod.ZodOptional<zod.ZodString>;
...
export declare const SearchHistoryCallQueryParams: zod.ZodObject<
	{
		...
		'talk.from': zod.ZodOptional<zod.ZodString>;
		'talk.to': zod.ZodOptional<zod.ZodString>;
		rated: zod.ZodOptional<zod.ZodBoolean>;
		ratedBy: zod.ZodOptional<zod.ZodArray<zod.ZodString>>;
		'scoreRequired.from': zod.ZodOptional<zod.ZodString>;
		'scoreRequired.to': zod.ZodOptional<zod.ZodString>;
		'scoreOptional.from': zod.ZodOptional<zod.ZodString>;
		'scoreOptional.to': zod.ZodOptional<zod.ZodString>;
