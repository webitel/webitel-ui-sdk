...
export const searchHistoryCallResponse = zod.object({
  ...
  "billSec": zod.number().optional(),
  "blindTransfer": zod.string().optional(),
  "blindTransfers": zod.array(zod.object({
  "number": zod.string().optional(),
  ...
  "id": zod.string().optional(),
  "state": zod.enum(['idle', 'active', 'finished', 'error']).default(searchHistoryCallResponseItemsItemFilesJobItemStateDefault)
})).optional(),
...
export const searchHistoryCallPostBody = zod.object({
  ...
  "ratedUser": zod.array(zod.string()).optional(),
  "schemaId": zod.array(zod.number()).optional(),
  "scoreOptional": zod.object({
  "from": zod.string().optional(),
  "to": zod.string().optional()
}).optional(),
  "scoreRequired": zod.object({
  "from": zod.string().optional(),
  "to": zod.string().optional()
}).optional(),
  "size": zod.number().optional(),
...
export const searchHistoryCallPostResponse = zod.object({
  ...
  "fileId": zod.string().optional(),
  "id": zod.string().optional(),
  "state": zod.enum(['idle', 'active', 'finished', 'error']).default(searchHistoryCallPostResponseItemsItemFilesJobItemStateDefault)
})).optional(),
  "forms": zod.array(zod.object({
  "agent": zod.object({
  "id": zod.string().optional(),
...
export const patchHistoryCallResponse = zod.object({
  ...
  "fileId": zod.string().optional(),
  "id": zod.string().optional(),
  "state": zod.enum(['idle', 'active', 'finished', 'error']).default(patchHistoryCallResponseFilesJobItemStateDefault)
})).optional(),
  "forms": zod.array(zod.object({
  "agent": zod.object({
  "id": zod.string().optional(),
