	...
	getLoggerService =
		...
		(axiosInstance: AxiosInstance = axios) => {
			...
			const loggerServiceSearchLogByConfigId = (
				...
				return axiosInstance.get(`/logger/config/${configId}/logs`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const loggerServiceSearchLogByUserId = (
				...
				return axiosInstance.get(`/logger/user/${userId}/logs`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const loggerServiceSearchLogByRecordId = (
				...
				return axiosInstance.get(`/logger/${object}/record/${recordId}/logs`, {
					...options,
					params: {
						...params,
						...options?.params,
