...
import type {
	...
	StorageFileServiceDeleteVideocallFilesBody,
	StorageListFile,
...
export declare const // --- title start
	getFileService: (axiosInstance?: AxiosInstance) => {
		deleteVideocallFiles: (
			callId: string,
			storageFileServiceDeleteVideocallFilesBody: StorageFileServiceDeleteVideocallFilesBody,
...
export type DeleteVideocallFilesResult =
