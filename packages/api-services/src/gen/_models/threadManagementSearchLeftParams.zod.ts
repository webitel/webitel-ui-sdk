 ...
 */
import type { ThreadManagementSearchLeftTypesItem } from './threadManagementSearchLeftTypesItem.zod';

export type ThreadManagementSearchLeftParams = {
	/**
	 ...
	 */
	types?: ThreadManagementSearchLeftTypesItem[];
	/**
	 * Sorting field.
