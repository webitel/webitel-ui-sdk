 ...
 */
import type { WebitelImApiGatewayV1AuthContactMetadata } from './webitelImApiGatewayV1AuthContactMetadata.zod';

export interface WebitelImApiGatewayV1AuthContact {
	/**
	...
	metadata?: WebitelImApiGatewayV1AuthContactMetadata;
	/**
