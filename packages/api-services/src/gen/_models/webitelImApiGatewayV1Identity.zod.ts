 ...
 */
import type { WebitelImApiGatewayV1IdentityMetadata } from './webitelImApiGatewayV1IdentityMetadata.zod';

export interface WebitelImApiGatewayV1Identity {
	/**
	...
	metadata?: WebitelImApiGatewayV1IdentityMetadata;
	/**
