...
import type { UsersUpdateUserUserBodyProfile } from './usersUpdateUserUserBodyProfile';

export type UsersUpdateUserUserBody = {
...
For example, "chat_name" is shown when an agent connects to chats with clients. */
 ...
 string status = 8; // short display status (short description) */
	...
	profile?: UsersUpdateUserUserBodyProfile;
	roles?: ApiObjectId[];
	totp_url?: string;
	updated_at?: string;
