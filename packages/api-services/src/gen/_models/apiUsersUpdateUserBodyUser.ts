...
import type { ApiUsersUpdateUserBodyUserProfile } from './apiUsersUpdateUserBodyUserProfile';

export type ApiUsersUpdateUserBodyUser = {
 ...
 string status = 8; // short display status (short description) */
	...
	profile?: ApiUsersUpdateUserBodyUserProfile;
	roles?: ApiObjectId[];
	totpUrl?: string;
	updatedAt?: string;
	updatedBy?: ApiUserId;
