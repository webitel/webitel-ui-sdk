	...
	getContactGroups =
		...
		(axiosInstance: AxiosInstance = axios) => {
			...
			const deleteContactGroups = (
				...
				return axiosInstance.delete(`/contacts/${contactId}/groups`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const listContactGroups = (
				...
				return axiosInstance.get(`/contacts/${contactId}/groups`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const deleteContactGroup = (
				...
				return axiosInstance.delete(`/contacts/${contactId}/groups/${etag}`, {
					...options,
					params: {
						...params,
						...options?.params,
			 ...
			 */
			const locateContactGroup = (
				contactId: string,
				etag: string,
				params?: LocateContactGroupParams,
				options?: AxiosRequestConfig,
			): Promise<AxiosResponse<ContactsContactGroup>> => {
				return axiosInstance.get(`/contacts/${contactId}/groups/${etag}`, {
					...options,
					params: {
						...params,
						...options?.params,
