 ...
 */
const deleteContactGroups = <TData = AxiosResponse<ContactsContactGroupList>>(
    contactId: string,
    params: DeleteContactGroupsParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.delete(
 ...
 */
const listContactGroups = <TData = AxiosResponse<ContactsContactGroupList>>(
    contactId: string,
    params?: ListContactGroupsParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
      `/contacts/${contactId}/groups`,{
    ...options,
 ...
 */
const mergeContactGroups = <TData = AxiosResponse<ContactsContactGroupList>>(
    contactId: string,
    contactsInputContactGroup: ContactsInputContactGroup[],
    params?: MergeContactGroupsParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/contacts/${contactId}/groups`,
      contactsInputContactGroup,{
 ...
 */
const resetContactGroups = <TData = AxiosResponse<ContactsContactGroupList>>(
    contactId: string,
    contactsInputContactGroup: ContactsInputContactGroup[],
    params?: ResetContactGroupsParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.put(
      `/contacts/${contactId}/groups`,
      contactsInputContactGroup,{
...
const deleteContactGroup = <TData = AxiosResponse<ContactsContactGroup>>(
    contactId: string,
    etag: string,
    params?: DeleteContactGroupParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.delete(
...
const locateContactGroup = <TData = AxiosResponse<ContactsContactGroup>>(
    contactId: string,
    etag: string,
    params?: LocateContactGroupParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
      `/contacts/${contactId}/groups/${etag}`,{
    ...options,
 ...
 */
const updateContactGroup2 = <TData = AxiosResponse<ContactsContactGroupList>>(
    contactId: string,
    etag: string,
    updateContactGroup2Body: UpdateContactGroup2Body,
    params?: UpdateContactGroup2Params, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.patch(
      `/contacts/${contactId}/groups/${etag}`,
      updateContactGroup2Body,{
 ...
 * @summary Update the Contact's group details.
 */
const updateContactGroup = <TData = AxiosResponse<ContactsContactGroupList>>(
    contactId: string,
    etag: string,
    updateContactGroupBody: UpdateContactGroupBody,
    params?: UpdateContactGroupParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.put(
      `/contacts/${contactId}/groups/${etag}`,
      updateContactGroupBody,{
    ...options,
        params: {...params, ...options?.params},}
            ...
            // --- footer start
            return {deleteContactGroups,listContactGroups,mergeContactGroups,resetContactGroups,deleteContactGroup,locateContactGroup,updateContactGroup2,updateContactGroup}};
