...
export const searchContactsQueryFieldsItemDefault = `*`;export const searchContactsQueryModeDefault = `READ`;

export const SearchContactsQueryParams = zod.object({
  "page": zod.number().optional().describe('Page number of result records.   _default(1); offset=(size*(page-1));_\n\n```javascript\nlet\n    offset = 0\n  , page = req.page\n;\nif (page <= 0)\n    page = 1;\nif (page > 1)\n    offset = ((page-1)*size);\n// . . .\n```'),
  ...
  "sort": zod.array(zod.string().regex(searchContactsQuerySortItemRegExp)).optional().describe('Sort result dataset of records by fields.\n```\nsort ::= *( ORDER name )\n\nORDER  = ASC / DESC\nDESC   = \"-\" / \"!\"\nASC    = [ \"+\" ]   ; Default\n```\n\nFields available\n\n- `id`(seq)\n- `domain`{name}\n- `created_at`\n- `created_by`{name}\n- `updated_at`\n- `updated_by`{name}\n\nUse ?fields=`field.sort()` option to sort Edge fields.'),
  ...
  "qin": zod.array(zod.string()).optional().describe('[Q]uery[IN] is a set of search fields for term `q`.\nDefault: `name{common_name}`.'),
  "mode": zod.enum(['READ', 'WRITE', 'DELETE']).default(searchContactsQueryModeDefault).describe('Source access mode requirement.\n\n - READ: Can `fetch` record. [GET]\n - WRITE: Can `update` record. [PUT|PATCH]\n - DELETE: Can `delete` record. [DELETE]'),
  "notIdGroup": zod.string().optional().describe('Excludes contacts that belong to the specified group ID.\n- Filters out contacts associated with the given `group_id`.'),
  "group": zod.array(zod.string()).optional().describe('Filters contacts by the specified group(s).\n- Includes only contacts that belong to one or more of the given group Group(s).'),
  "owner": zod.array(zod.string()).optional().describe('Filters contacts by the specified owner(s).\n- Includes only contacts whose owner matches one or more of the given Owner(s).\n- The owner ID corresponds to `contact_id` in the `directory.wbt_user` table.'),
  "label": zod.array(zod.string()).optional().describe('Filters contacts by the specified label(s).\n- Includes only contacts that have one or more of the given Label(s).'),
  "user": zod.boolean().optional().describe('Filters contacts based on whether they are user-associated.\n- `true`  → Includes only user-associated contacts.\n- `false` → Includes only contacts that are NOT user-associated.\n- A contact is considered user-associated if it exists in `directory.wbt_user`.')
})

export const SearchContactsResponse = zod.object({
  "data": zod.array(zod.object({
  "about": zod.string().optional().describe('BIO. Short description about the Contact person.\nOPTIONAL. Multi-lined text.'),
  "comments": zod.object({
  "data": zod.array(zod.object({
...
}).optional().describe('Comment dataset.'),
  ...
  "next": zod.boolean().optional(),
  "page": zod.number().optional().describe('The page number of the partial result.')
}).optional().describe('Email dataset.'),
  "etag": zod.string().optional().describe('Unique ID of the latest version of the update.\nThis ID changes after any update to the underlying value(s).'),
  "groups": zod.object({
  "data": zod.array(zod.object({
  "createdAt": zod.string().optional().describe('The user who created this Field.'),
  ...
  "ver": zod.number().optional().describe('Version of the latest update. Numeric sequence.')
}).describe('The Contact\'s Group association.')).optional().describe('Group dataset page.'),
  "next": zod.boolean().optional(),
  "page": zod.number().optional().describe('The page number of the partial result.')
}).optional().describe('Contact groups dataset.\nNOTE: Edge represents connection between two nodes.\nSo this ContactGroupList.data are always subordinate to some contact.id.'),
  "id": zod.string().optional().describe('The unique ID of the association. Never changes.'),
  "imclients": zod.object({
  "data": zod.array(zod.object({
  "app": zod.object({
  "id": zod.string().optional().describe('Reference Object unique ID.'),
  "name": zod.string().optional().describe('Reference Object display name.'),
  ...
  "id": zod.string().optional().describe('The unique ID of the association. Never changes.'),
  "protocol": zod.string().optional().describe('Protocol used to connect the IM client.'),
  "updatedAt": zod.string().optional().describe('Timestamp(milli) of the last Field update.\nTake part in Etag generation.'),
  "updatedBy": zod.object({
  "id": zod.string().optional().describe('Reference Object unique ID.'),
  "name": zod.string().optional().describe('Reference Object display name.'),
  ...
  "ver": zod.number().optional().describe('Version of the latest update. Numeric sequence.'),
  "via": zod.string().optional().describe('[Via] App(-specific) peer(-id) to connect[from] the IM client.')
}).describe('A contact\'s [I]nstant[M]essaging client.')).optional().describe('IMClient dataset page.'),
  "next": zod.boolean().optional(),
  "page": zod.number().optional().describe('The page number of the partial result.')
}).optional(),
  "labels": zod.object({
  ...
  "next": zod.boolean().optional(),
  "page": zod.number().optional().describe('The page number of the partial result.')
}).optional().describe('PhoneNumber dataset.'),
  "photos": zod.object({
  "data": zod.array(zod.object({
  "createdAt": zod.string().optional().describe('The user who created this Field.'),
  "createdBy": zod.object({
  ...
  "next": zod.boolean().optional(),
  "page": zod.number().optional().describe('The page number of the partial result.')
}).optional().describe('Photo dataset.'),
  "timezones": zod.object({
  "data": zod.array(zod.object({
  "createdAt": zod.string().optional().describe('The user who created this Field.'),
  "createdBy": zod.object({
  "id": zod.string().optional().describe('Reference Object unique ID.'),
...
export const CreateContactBody = zod.object({
...
})).optional().describe('Publish NEW comment(s) for this Contact.'),
  ...
  "verified": zod.boolean().optional()
}).describe('Input of the Contact\'s email address.')).optional().describe('The Contact\'s email address(es).'),
  "etag": zod.string().optional().describe('Unique ID of the latest version of an existing resorce.'),
...
}).describe('An input of the Contact\'s groups.')).optional().describe('The Contact\'s associated group(s).'),
  "imclients": zod.array(zod.object({
  "createdBy": zod.string().optional().describe('Id of Agent created this IM client.'),
  "externalUser": zod.string().optional(),
  "gatewayId": zod.string().optional().describe('App (Text-Gateway) used to connect the IM client.'),
  "protocol": zod.string().optional(),
  "via": zod.string().optional().describe('[Via] App(-specific) peer(-id) to connect[from] the IM client.')
}).describe('Input of the contact IM client.')).optional().describe('The contact\'s [I]nstant[M]essaging clients.'),
...
})).optional().describe('The Contact\'s internal manager(s).'),
  "name": zod.object({
  "commonName": zod.string().optional().describe('REQUIRED. End-User\'s full name in displayable form\nincluding all name parts, possibly including titles and suffixes,\nordered according to the End-User\'s locale and preferences.'),
  "familyName": zod.string().optional(),
  "givenName": zod.string().optional(),
  ...
  "verified": zod.boolean().optional()
}).describe('Input of the contact phone number.')).optional().describe('The Contact\'s phone numbers.'),
  "timezones": zod.array(zod.object({
  "etag": zod.string().describe('Unique ID of the latest version of an existing resource.'),
  "primary": zod.boolean().optional().describe('Indicates whether this association must be default among others.'),
  "timezone": zod.object({
  "id": zod.string().optional().describe('Reference Object unique ID.'),
...
}).describe('An input of the Contact\'s timezones.')).optional().describe('The Contact\'s timezone preference(s).'),
  "variables": zod.array(zod.object({
  "etag": zod.string().optional().describe('Unique ID of the latest version of an existing resorce.'),
  "key": zod.string().regex(createContactBodyVariablesItemKeyRegExp).describe('NEW Key.'),
  "value": zod.unknown().optional().describe('NEW Value.')
}).describe('Input of the Contact\'s variable.')).optional().describe('Arbitrary client data that is populated by clients.')
...
export const LocateContactParams = zod.object({
  "etag": zod.string().describe('The Contact source IDentifier.\nAccept: `etag` (obsolete+) or `id`.')
})
...
export const LocateContactQueryParams = zod.object({
  "fields": zod.array(zod.string()).optional().describe('Source Fields to return into result.'),
  "mode": zod.enum(['READ', 'WRITE', 'DELETE']).default(locateContactQueryModeDefault).describe('The requirement of a special access mode to the Source.\n\n - READ: Can `fetch` record. [GET]\n - WRITE: Can `update` record. [PUT|PATCH]\n - DELETE: Can `delete` record. [DELETE]')
})

export const LocateContactResponse = zod.object({
  "about": zod.string().optional().describe('BIO. Short description about the Contact person.\nOPTIONAL. Multi-lined text.'),
  "comments": zod.object({
  "data": zod.array(zod.object({
  "createdAt": zod.string().optional().describe('The user who created this Field.'),
...
export const UpdateContactBody = zod.object({
  ...
  "variables": zod.array(zod.object({
  "etag": zod.string().optional().describe('Unique ID of the latest version of an existing resorce.'),
  "key": zod.string().regex(updateContactBodyVariablesItemKeyRegExp).describe('NEW Key.'),
  "value": zod.unknown().optional().describe('NEW Value.')
}).describe('Input of the Contact\'s variable.')).optional().describe('Arbitrary client data that is populated by clients.')
})
