...
const searchContacts = <TData = AxiosResponse<ContactsContactList>>(
    params?: SearchContactsParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
      `/contacts`,{
    ...options,
...
const createContact = <TData = AxiosResponse<WebitelcontactsContact>>(
    ...
    params?: CreateContactParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/contacts`,
      contactsInputContact,{
...
const deleteContact = <TData = AxiosResponse<WebitelcontactsContact>>(
    etag: string,
    params?: DeleteContactParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.delete(
      `/contacts/${etag}`,{
    ...options,
...
const locateContact = <TData = AxiosResponse<WebitelcontactsContact>>(
    etag: string,
    params?: LocateContactParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
      `/contacts/${etag}`,{
    ...options,
...
const updateContact = <TData = AxiosResponse<WebitelcontactsContact>>(
    ...
    params?: UpdateContactParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.patch(
      `/contacts/${etag}`,
      updateContactBody,{
    ...options,
        params: {...params, ...options?.params},}
            ...
            // --- footer start
            return {searchContacts,createContact,deleteContact,locateContact,updateContact}};
