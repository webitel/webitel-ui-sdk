...
getWorkingConditionService: (axiosInstance?: AxiosInstance) => {
    workingConditionServiceSearchWorkingCondition: (params?: WorkingConditionServiceSearchWorkingConditionParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmSearchWorkingConditionResponse>>;
    workingConditionServiceCreateWorkingCondition: (wfmCreateWorkingConditionRequest: WfmCreateWorkingConditionRequest, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmCreateWorkingConditionResponse>>;
    workingConditionServiceDeleteWorkingCondition: (id: string, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmDeleteWorkingConditionResponse>>;
    workingConditionServiceReadWorkingCondition: (id: string, params?: WorkingConditionServiceReadWorkingConditionParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmReadWorkingConditionResponse>>;
    workingConditionServiceUpdateWorkingCondition: (workingConditionServiceUpdateWorkingConditionBody: WorkingConditionServiceUpdateWorkingConditionBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmUpdateWorkingConditionResponse>>;
};
