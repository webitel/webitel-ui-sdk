...
export declare const // --- title start
	getAgentService: (axiosInstance?: AxiosInstance) => {
		...
		agentSetState: (
			...
			options?: AxiosRequestConfig,
		) => Promise<AxiosResponse<EngineAgentSetStateResponse>>;
		searchAgentInQueueStatistics: (
			agentId: string,
			params?: SearchAgentInQueueStatisticsParams,
			options?: AxiosRequestConfig,
		) => Promise<AxiosResponse<EngineAgentInQueueStatisticsList>>;
		agentTodayStatistics: (
			agentId: string,
			params?: AgentTodayStatisticsParams,
			options?: AxiosRequestConfig,
		) => Promise<AxiosResponse<EngineAgentTodayStatisticsResponse>>;
		deleteAgent: (
			id: string,
