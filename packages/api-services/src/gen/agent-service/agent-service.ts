	...
	getAgentService =
		...
		(axiosInstance: AxiosInstance = axios) => {
			...
			const searchAgent = (
				...
				return axiosInstance.get(`/call_center/agents`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const searchAgentCallStatistics = (
				...
				return axiosInstance.get(`/call_center/agents/reports/call`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const searchAgentStatusStatistic = (
				...
				return axiosInstance.get(`/call_center/agents/reports/status`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const searchAgentStateHistory = (
				...
				return axiosInstance.get(`/call_center/agents/states/history`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const deleteAgent = (
				...
				return axiosInstance.delete(`/call_center/agents/${id}`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const readAgent = (
				...
				return axiosInstance.get(`/call_center/agents/${id}`, {
					...options,
					params: {
						...params,
						...options?.params,
 ...
 */
			const searchAgentInQueue = (
				...
				return axiosInstance.get(`/call_center/agents/${id}/queues`, {
					...options,
					params: {
						...params,
						...options?.params,
			 ...
			 */
			const searchAgentInTeam = (
				id: string,
				params?: SearchAgentInTeamParams,
				options?: AxiosRequestConfig,
			): Promise<AxiosResponse<EngineListAgentInTeam>> => {
				return axiosInstance.get(`/call_center/agents/${id}/teams`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const searchLookupUsersAgentNotExists = (
				...
				return axiosInstance.get(`/call_center/lookups/agents/users`, {
					...options,
					params: {
						...params,
						...options?.params,
			...
			const searchUserStatus = (
				...
				return axiosInstance.get(`/call_center/users`, {
					...options,
					params: {
						...params,
						...options?.params,
