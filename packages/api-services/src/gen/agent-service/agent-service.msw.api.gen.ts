...
export const getSearchAgentCallStatisticsResponseMock = (
	...
	items: faker.helpers.arrayElement([
		Array.from(
			...
			maxHoldSec: faker.helpers.arrayElement([faker.number.float(), undefined]),
			maxTalkSec: faker.helpers.arrayElement([faker.number.float(), undefined]),
			minHoldSec: faker.helpers.arrayElement([faker.number.float(), undefined]),
			minTalkSec: faker.helpers.arrayElement([faker.number.float(), undefined]),
			name: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
			occupancy: faker.helpers.arrayElement([faker.number.float(), undefined]),
			sumHoldSec: faker.helpers.arrayElement([faker.number.float(), undefined]),
			sumTalkSec: faker.helpers.arrayElement([faker.number.float(), undefined]),
...
export const getSearchAgentStatusStatisticItemResponseMock = (
	...
	pauseCause: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
	progressiveCount: faker.helpers.arrayElement([
		faker.number.int({ min: undefined, max: undefined }),
		undefined,
	]),
