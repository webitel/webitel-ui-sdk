...
export const SearchAgentQueryParams = zod.object({
	...
	supervisorId: zod.array(zod.int()).optional(),
	teamId: zod.array(zod.int()).optional(),
	regionId: zod.array(zod.int()).optional(),
	auditorId: zod.array(zod.int()).optional(),
	...
	notTeamId: zod.array(zod.int()).optional(),
	notSkillId: zod.array(zod.int()).optional(),
		...
		.array(
			zod.object({
				...
				channel: zod
					...
					.optional(),
				chatCount: zod.int().optional(),
				description: zod.string().optional(),
				extension: zod.string().optional(),
				extraChatCount: zod.int().optional(),
				greetingMedia: zod
					.object({
						id: zod.string().optional(),
						name: zod.string().optional(),
				...
				name: zod.string().optional(),
				progressiveCount: zod.int().optional(),
				region: zod
					.object({
						id: zod.string().optional(),
						name: zod.string().optional(),
...
export const SearchPauseCauseForAgentResponse = zod.object({
	items: zod
		.array(
			zod.object({
				durationMin: zod.int().optional(),
				id: zod.int().optional(),
				limitMin: zod.int().optional(),
				name: zod.string().optional(),
			}),
		)
		.optional(),
					...
					.array(
						zod.object({
							bucket: zod
								...
								.optional(),
							memberWaiting: zod.int().optional(),
							skill: zod
								.object({
									id: zod.string().optional(),
									name: zod.string().optional(),
