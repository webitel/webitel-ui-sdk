...
export const getListStatusesResponseMock = (
	overrideResponse: Partial<Extract<WebitelCasesStatusList, object>> = {},
): WebitelCasesStatusList => ({
...
export const getCreateStatusResponseMock = (
	overrideResponse: Partial<Extract<WebitelCasesStatus, object>> = {},
): WebitelCasesStatus => ({
	createdAt: faker.helpers.arrayElement([
		faker.string.alpha({
			length: {
...
export const getLocateStatusResponseMock = (
	overrideResponse: Partial<
		Extract<WebitelCasesLocateStatusResponse, object>
	> = {},
): WebitelCasesLocateStatusResponse => ({
