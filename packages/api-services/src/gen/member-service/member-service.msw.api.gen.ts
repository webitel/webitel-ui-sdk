		...
		Array.from(
			...
			communications: faker.helpers.arrayElement([
				Array.from(
					...
					dtmf: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
					id: faker.helpers.arrayElement([
						faker.number.int({ min: undefined, max: undefined }),
						undefined,
					]),
...
export const getPatchMemberOneResponseMock = (
	...
	stopCause: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
	timezone: faker.helpers.arrayElement([
		{
			id: faker.helpers.arrayElement([
				faker.number.int({ min: undefined, max: undefined }),
...
export const getSearchMemberAttemptsResponseMock = (
	...
	items: faker.helpers.arrayElement([
		Array.from(
			...
			legAId: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
			legBId: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
			logs: faker.helpers.arrayElement([{}, undefined]),
			member: faker.helpers.arrayElement([
				{
					id: faker.helpers.arrayElement([
						faker.number.int({ min: undefined, max: undefined }),
			...
			node: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
