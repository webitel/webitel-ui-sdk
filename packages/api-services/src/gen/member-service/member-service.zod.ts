...
export const AttemptCallbackBody = zod.object({
	...
	waitBetweenRetries: zod.int().optional(),
});
...
export const SearchMembersQueryParams = zod.object({
	...
	'offeringAt.from': zod.string().optional(),
	'offeringAt.to': zod.string().optional(),
...
export const SearchAttemptsQueryParams = zod.object({
	...
	'leavingAt.from': zod.string().optional(),
	'leavingAt.to': zod.string().optional(),
	'offeringAt.from': zod.string().optional(),
	'offeringAt.to': zod.string().optional(),
