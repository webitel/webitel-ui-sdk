...
getMemberService: (axiosInstance?: AxiosInstance) => {
    ...
    searchMembers: (params?: SearchMembersParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineListMember>>;
    patchMemberOne: (id: string, engineMemberServicePatchMemberOneBody: EngineMemberServicePatchMemberOneBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineMemberInQueue>>;
    ...
    searchMemberInQueue: (queueId: number, params?: SearchMemberInQueueParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineListMember>>;
    createMember: (queueId: string, engineMemberServiceCreateMemberBody: EngineMemberServiceCreateMemberBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineMemberInQueue>>;
    createMemberBulk: (queueId: string, engineMemberServiceCreateMemberBulkBody: EngineMemberServiceCreateMemberBulkBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineMemberBulkResponse>>;
    resetMembers: (queueId: string, engineMemberServiceResetMembersBody: EngineMemberServiceResetMembersBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineResetMembersResponse>>;
    deleteMember: (queueId: string, id: string, params?: DeleteMemberParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineMemberInQueue>>;
    readMember: (queueId: string, id: string, params?: ReadMemberParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineMemberInQueue>>;
    patchMember: (queueId: string, id: string, engineMemberServicePatchMemberBody: EngineMemberServicePatchMemberBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineMemberInQueue>>;
    updateMember: (queueId: string, id: string, engineMemberServiceUpdateMemberBody: EngineMemberServiceUpdateMemberBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineMemberInQueue>>;
    searchMemberAttempts: (queueId: string, memberId: string, params?: SearchMemberAttemptsParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineListMemberAttempt>>;
    createAttempt: (queueId: string, memberId: string, engineMemberServiceCreateAttemptBody: EngineMemberServiceCreateAttemptBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineCreateAttemptResponse>>;
    attemptResult: (queueId: number, memberId: string, attemptId: string, engineMemberServiceAttemptResultBody: EngineMemberServiceAttemptResultBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<EngineAttemptResultResponse>>;
};
