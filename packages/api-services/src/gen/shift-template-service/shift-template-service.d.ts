...
getShiftTemplateService: (axiosInstance?: AxiosInstance) => {
    shiftTemplateServiceSearchShiftTemplate: (params?: ShiftTemplateServiceSearchShiftTemplateParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmSearchShiftTemplateResponse>>;
    shiftTemplateServiceCreateShiftTemplate: (wfmCreateShiftTemplateRequest: WfmCreateShiftTemplateRequest, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmCreateShiftTemplateResponse>>;
    shiftTemplateServiceDeleteShiftTemplate: (id: string, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmDeleteShiftTemplateResponse>>;
    shiftTemplateServiceReadShiftTemplate: (id: string, params?: ShiftTemplateServiceReadShiftTemplateParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmReadShiftTemplateResponse>>;
    shiftTemplateServiceUpdateShiftTemplate: (shiftTemplateServiceUpdateShiftTemplateBody: ShiftTemplateServiceUpdateShiftTemplateBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<WfmUpdateShiftTemplateResponse>>;
};
