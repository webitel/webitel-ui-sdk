...
getCaseCommunications: (axiosInstance?: AxiosInstance) => {
    listCommunications: (caseEtag: string, params?: ListCommunicationsParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<WebitelCasesListCommunicationsResponse>>;
    linkCommunication: (caseEtag: string, webitelCasesInputCaseCommunication: WebitelCasesInputCaseCommunication, params?: LinkCommunicationParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<WebitelCasesLinkCommunicationResponse>>;
    unlinkCommunication: (caseEtag: string, id: string, params?: UnlinkCommunicationParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<WebitelCasesUnlinkCommunicationResponse>>;
};
