...
getCases: () => {
    ...
    updateCase2: <TData = AxiosResponse<WebitelCasesCase, any>>(updateCase2Body: UpdateCase2Body, params?: UpdateCase2Params, options?: AxiosRequestConfig) => Promise<TData>;
    updateCase: <TData = AxiosResponse<WebitelCasesCase, any>>(updateCaseBody: UpdateCaseBody, params?: UpdateCaseParams, options?: AxiosRequestConfig) => Promise<TData>;
