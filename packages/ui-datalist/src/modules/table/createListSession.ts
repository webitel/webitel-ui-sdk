...
/**
 * List-session: one deep module for a registry or nested list.
 * Headers, pagination and filters stay as internal adapters; callers and
 * package extensions (presets, permissions) compose through this interface.
 */
export const createListSession = <Entity extends Identifiable>(
	namespace: string,
...
export type ListSession = ReturnType<typeof createListSession>;

/** @deprecated use createListSession — kept for in-flight branches */
export const tableStoreBody = createListSession;
