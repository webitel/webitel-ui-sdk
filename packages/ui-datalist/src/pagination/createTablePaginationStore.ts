...
export const createTablePaginationStore = (mainNamespace: string, ...rest) => {
  const namespace = `${mainNamespace}/pagination`;

  return createDatalistStore(tablePaginationStoreBody)(namespace, ...rest);
};
